  ...
  server.registerTool(
    'generator-guide',
    {
      description:
        ...
        '(e.g. infra, iacProvider, auth, uxProvider, protocol, sourceType, targetType) ' +
      ...
      inputSchema: {
        ...
        options: z
          ...
          .optional()
          .describe(
            'Optional map of generator option values (e.g. { infra: "rest-lambda", iacProvider: "cdk" }) used to filter the guide to content that applies to those choices.',
          ),
      },
    },
