...
export const TS_VERSIONS = {
  ...
  '@aws-sdk/client-appconfigdata': '3.1131.0',
  '@middy/core': '7.9.2',
  '@nxlv/python': '23.0.2',
  ...
  '@cloudscape-design/chat-components': '1.0.172',
  '@cloudscape-design/components': '3.0.1377',
  '@cloudscape-design/global-styles': '1.0.69',
