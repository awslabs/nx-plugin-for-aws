...
export const TS_VERSIONS = {
  '@aws-sdk/client-cognito-identity': '3.964.0',
  '@aws-sdk/client-dynamodb': '3.964.0',
  '@aws-sdk/credential-providers': '3.964.0',
  '@aws-sdk/credential-provider-cognito-identity': '3.964.0',
  '@aws-smithy/server-apigateway': '1.0.0-alpha.10',
  '@aws-smithy/server-node': '1.0.0-alpha.10',
  '@aws-lambda-powertools/logger': '2.30.1',
  '@aws-lambda-powertools/metrics': '2.30.1',
  '@aws-lambda-powertools/tracer': '2.30.1',
  '@aws-lambda-powertools/parser': '2.30.1',
  '@middy/core': '6.4.5',
  '@nxlv/python': '21.2.1',
