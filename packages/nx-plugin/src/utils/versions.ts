...
export const TS_VERSIONS = {
  ...
  '@aws-sdk/client-appconfigdata': '3.1045.0',
  '@middy/core': '7.5.0',
  '@nxlv/python': '22.1.4',
  ...
  '@cloudscape-design/chat-components': '1.0.125',
  '@cloudscape-design/components': '3.0.1292',
  ...
  'aws-cdk': '2.1121.0',
  'aws-cdk-lib': '2.253.1',
  '@aws-cdk/aws-bedrock-agentcore-alpha': '2.253.1-alpha.0',
