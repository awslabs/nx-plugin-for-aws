...
export const TS_VERSIONS = {
  ...
  '@aws-sdk/client-appconfigdata': '3.1019.0',
  '@middy/core': '7.2.1',
  '@nxlv/python': '22.1.1',
  '@nx-extend/terraform': '10.2.1',
  '@nx/devkit': '22.6.3',
  '@nx/react': '22.6.3',
  'create-nx-workspace': '22.6.3',
  ...
  '@cloudscape-design/board-components': '3.0.159',
  '@cloudscape-design/components': '3.0.1255',
  '@cloudscape-design/global-styles': '1.0.54',
