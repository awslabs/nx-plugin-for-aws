---
title: '@aws/nx-plugin'
description: 'AWS 프로젝트를 쉽게 부트스트랩 및 빌드 (NX 플러그인 포함)'
template: splash
hero:
  tagline: 'AWS 프로젝트를 쉽게 부트스트랩 및 빌드 (NX 플러그인 포함)'
  image:
...
{/* TODO: 아래 gif를 워치 앤 런 시리즈로 교체 필요 */}
{/* ##### 워치 앤 런 시리즈 */}
