...
:::tip[시각적으로 스케치하기]
워크스페이스를 먼저 설계하고 싶으신가요? <Link path="get_started/graph-builder">Graph Builder</Link>를 사용하면 프로젝트를 드래그하고 프로젝트 간의 연결을 그린 다음, 전체를 스캐폴딩할 명령을 제공받을 수 있습니다.
:::
...
<CardGrid>
  ...
  <ConnectionCard
    ...
    description="FastAPI를 Python Aurora 관계형 데이터베이스에 연결하기"
  ...
  <ConnectionCard
    ...
    description="Python Agent를 Python Aurora 관계형 데이터베이스에 연결하기"
  ...
  <ConnectionCard
    ...
    description="Python MCP Server를 Python Aurora 관계형 데이터베이스에 연결하기"
  ...
  <ConnectionCard
    ...
    description="에이전트를 런타임 타겟으로 AgentCore Gateway로 프론트하기"
  ...
  <ConnectionCard
    ...
    description="React 웹사이트를 AgentCore Gateway를 통해 에이전트에 연결하기"
