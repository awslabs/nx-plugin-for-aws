...
진입점은 A2A 프로토콜을 통해 에이전트를 노출합니다(Strands는 [Strands A2A Server](https://strandsagents.com/docs/user-guide/concepts/multi-agent/agent-to-agent)를 사용하고, LangChain은 그래프를 [`a2a-sdk`](https://a2a-protocol.org/) 실행자로 래핑합니다). FastAPI 앱에 마운트됩니다:
