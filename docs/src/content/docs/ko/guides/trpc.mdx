...
<OptionFilter when={{ infra: 'rest-lambda' }} description="액세스 로깅 — REST API는 기본적으로 CloudWatch에 요청을 기록합니다">
### 액세스 로깅
...
<OptionFilter when={{ auth: 'iam' }} description="API 호출 액세스 부여 — IAM 인증 API 전용">
### 액세스 부여 (IAM 전용)
