...
워크스페이스의 다른 프로젝트와 이 프로젝트를 통합하려면 <Link path="guides/connection">`connection`</Link> 생성기를 사용하세요. 다음 연결은 이 프로젝트와 관련이 있습니다:
...
<CardGrid>
  ...
  <ConnectionCard
    ...
    description="TypeScript MCP 서버를 Aurora 관계형 데이터베이스에 연결"
  ...
  <ConnectionCard
    ...
    description="TypeScript MCP 서버를 DynamoDB 테이블에 연결"
