...
:::tip[권장 설정]
생성하는 모든 generator의 기본 프로젝트로 <Link path="/ko/guides/ts-nx-plugin">`ts#nx-plugin`</Link> generator를 사용하는 것을 권장합니다. 이 generator는 AI가 generator를 사용할 수 있도록 돕는 MCP Server도 제공합니다.
:::
...
:::tip[Generator 기여하기]
Nx Plugin for AWS에 기여하는 것에 대한 더 자세한 가이드는 <Link path="/ko/get_started/tutorials/contribute-generator">여기의 튜토리얼</Link>을 참조하세요.
:::