...
:::tip
DynamoDB 스트림 또는 EventBridge 이벤트와 같이 이벤트 내에 사용자 정의 데이터가 중첩된 경우, 해당 사용자 정의 데이터에 대한 타입 안전성을 제공하기 위해 [Envelopes](https://docs.powertools.aws.dev/lambda/python/latest/utilities/parser/#envelopes)를 사용하면 도움이 될 수 있습니다.
:::
