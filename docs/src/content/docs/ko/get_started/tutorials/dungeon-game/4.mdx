...
:::tip[사전 구성된 API 연동]
`connection` 제너레이터를 사용했기 때문에 Game API 통합이 이미 구성되어 있습니다. 에이전트에 대해서도 유사한 경험을 원하시면 [이 GitHub 이슈](https://github.com/awslabs/nx-plugin-for-aws/issues/326)에 +1을 남겨주세요.
:::
