...
- React/Vite 프론트엔드 웹사이트:
  ...
  - UI 프리미티브 및 테마를 위한 [shadcn/ui](https://ui.shadcn.com/).
  - 에이전트와 직접 대화하는 채팅 경험을 위한 [CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/).
...
- AG-UI 프로토콜을 통해 노출되고 [Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/)에 호스팅된 [Strands](https://strandsagents.com/) 에이전트. 채팅 기록은 AgentCore Runtime에 의해 세션별로 자동으로 유지됩니다.
