...
이 명령어는 웹사이트가 tRPC API를 호출할 수 있도록 필요한 프로바이더를 구성합니다.

### CDK 인프라 추가

<RunGenerator generator="ts#infra" requiredParameters={{ name: 'infra' }} />

이 명령어는 AWS에 인프라를 배포할 수 있는 CDK 앱을 구성합니다.

## 3단계: 클라우드 리소스 정의 및 AWS 배포
