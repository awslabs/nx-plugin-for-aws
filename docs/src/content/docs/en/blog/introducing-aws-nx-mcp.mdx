...
If you're interested in exploring AI-assisted AWS development with more structure and reliability, try the Nx Plugin for AWS MCP Server. You can set it up in your favourite AI Assistant (Kiro, Kiro CLI, Cline, Claude Code, etc) with the following MCP Server configuration:
