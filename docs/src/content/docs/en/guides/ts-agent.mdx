...
If you selected `None` for `computeType`, no CDK constructs or Terraform modules are generated — the Agent can only be run locally.
</OptionFilter>
