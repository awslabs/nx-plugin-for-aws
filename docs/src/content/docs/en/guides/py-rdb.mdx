...
For Debian-based container images, add the Amazon RDS CA bundle to the system trust store:
...
For Amazon Linux-based container images, use the `update-ca-trust` command instead:
