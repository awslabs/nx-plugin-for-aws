...
The database migration and create-db-user handlers run as container images built during your project's `build`. These images are scanned for vulnerabilities as described below.
