...
This allows you to define data models using [Pydantic](https://docs.pydantic.dev/latest/), in a similar manner to working with [FastAPI](/nx-plugin-for-aws/guides/fastapi).
