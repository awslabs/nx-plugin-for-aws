...
The generator will also create CDK or Terraform infrastructure as code which can be used to deploy your API, which resides in the `packages/common` directory.
