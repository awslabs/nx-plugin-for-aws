...
The `UserIdentity` construct automatically adds the necessary [Runtime Configuration](/nx-plugin-for-aws/guides/cloudscape-website#runtime-configuration) to ensure that your website can point to the correct Cognito User Pool for authentication.
