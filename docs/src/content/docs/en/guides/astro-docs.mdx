...
| `translationCommitMessage` | Commit message marker for translation commits. Not in the generated config — add the key to override its `docs: update translations` default. |
