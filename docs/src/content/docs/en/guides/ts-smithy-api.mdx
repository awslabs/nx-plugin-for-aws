...
The backend project uses [Rolldown](https://rolldown.rs/) to bundle your service handler into a deployment package for AWS Lambda.
...
To invoke your API from a React website, you can use the <Link path="guides/api-connection/react-smithy">`api-connection`</Link> generator, which provides type-safe client generation from your Smithy model.
