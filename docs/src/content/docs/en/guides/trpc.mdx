...
:::note
An alias is added to `tsconfig.base.json` in the root of your monorepo to resolve Zod to [version 4.x](https://zod.dev/v4). This is to future-proof for when Zod v4 is released to NPM, allowing for an upgrade without changing import paths.
:::
