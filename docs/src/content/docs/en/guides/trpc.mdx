...
The construct creates a Lambda Authorizer internally from the generated `src/authorizer.ts` file, which denies all requests by default. Implement your custom authorization logic in that file.
</OptionFilter>
