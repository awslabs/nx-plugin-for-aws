...
If you are calling your API from a React website, consider using the <Link path="guides/connection/react-trpc">API Connection</Link> generator to configure the client.
