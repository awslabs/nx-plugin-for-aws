...
:::caution[AG-UI not yet supported for TypeScript]
The [AG-UI protocol](https://docs.ag-ui.com/) is not yet supported for TypeScript Strands Agents. If you need AG-UI support, please use the <Link path="/guides/py-strands-agent">`py#strands-agent`</Link> generator with `protocol=AG-UI`. See [strands-agents/sdk-typescript#347](https://github.com/strands-agents/sdk-typescript/issues/347) for TypeScript AG-UI support status.
:::
