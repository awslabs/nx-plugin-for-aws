...
:::tip
For a streamlined setup, use the <Link path="/guides/connection/react-strands-agent">Connection generator</Link> to connect your React website to a Strands Agent, which automatically sets up the tRPC WebSocket client with the correct authentication.
