...
:::tip
If you'd like a similar experience to the <Link path="/guides/api-connection">API connection generator</Link> for agents, please +1 [this GitHub issue](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::
