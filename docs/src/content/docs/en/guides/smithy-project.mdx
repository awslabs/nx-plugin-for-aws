...
:::caution[Windows]
`mise` publishes no Windows package to npm, so install the Smithy CLI yourself before building:
...
See the [Smithy CLI installation guide](https://smithy.io/2.0/guides/smithy-cli/cli_installation.html) for other options.
:::
