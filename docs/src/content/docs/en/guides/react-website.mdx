...
:::note[shadcn/ui]
You selected [shadcn/ui](https://ui.shadcn.com/) as your `uxProvider`. Generated components and styles sit alongside TanStack Router / Vite — refer to the Shadcn docs for adding further components.
:::
</OptionFilter>

<OptionFilter when={{ uxProvider: 'None' }} description="No UX provider — bring your own component library">
:::note[No UX Provider]
You selected `None` for `uxProvider`, so no component library or design system is wired in. You are free to add the component library of your choice.
:::
</OptionFilter>
