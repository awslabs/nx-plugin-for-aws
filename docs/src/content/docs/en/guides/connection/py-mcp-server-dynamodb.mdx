...
`my_scope_my_table` is the module name of your DynamoDB project — a single flat module named `<scope>_<name>`, visible as the package directory inside the project.
