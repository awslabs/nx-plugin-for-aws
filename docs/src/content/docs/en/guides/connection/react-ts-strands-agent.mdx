...
At the time of writing, the agent core runtime's `grantInvoke` method does not yet include this permission automatically (see [aws-cdk#37495](https://github.com/aws/aws-cdk/issues/37495)).
:::
