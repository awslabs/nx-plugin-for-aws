...
:::caution
Because `package` skips the quality gates, a deploy no longer fails on a lint error or a failing unit test. Run `build` (or your CI pipeline) to check your code.
:::
