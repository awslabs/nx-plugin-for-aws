...
You may wish to scope this down to the specific model(s) your agent uses. Strands agents use [Claude 4 Sonnet as the default model](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/amazon-bedrock/#default-model); see the [Strands model providers guide](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/) for configuring a different model.

<Infrastructure>
<Fragment slot="cdk">
To scope down, edit the generated agent CDK construct and replace the default `PolicyStatement` resources with the ARNs of the specific foundation models or inference profiles you use.
</Fragment>
<Fragment slot="terraform">
To scope down, edit the generated agent Terraform module and replace the default bedrock model `Resource` ARNs with the ARNs of the specific foundation models or inference profiles you use.
</Fragment>
</Infrastructure>
:::
