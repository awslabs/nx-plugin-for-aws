...
<div class="landing-section landing-carousel-section">
  ...
  <p class="landing-lede">
    Each generator produces best-practice application code <em>and</em> the
    infrastructure to deploy it, getting you closer to production. Run them
    interactively — you'll be prompted for the values you need.
  </p>
  <GeneratorCarousel />
</div>
