...
:::note[Existing Git Repositories]
If the workspace directory is already within a Git repository, the Git initialization is skipped so your existing repository is left untouched.
:::
