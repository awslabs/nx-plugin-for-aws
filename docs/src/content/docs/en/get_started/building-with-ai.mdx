...
The Nx Plugin for AWS includes a [Skill](https://code.claude.com/docs/en/skills)/[Power](https://kiro.dev/docs/powers/) and an [MCP Server](https://modelcontextprotocol.io/introduction) which together enable AI assistants to work effectively with the plugin. By using these, you can accelerate your development workflow with AI while benefitting from your projects being scaffolded in a deterministic fashion — spending less time and less of your context window on setting up the main components.
