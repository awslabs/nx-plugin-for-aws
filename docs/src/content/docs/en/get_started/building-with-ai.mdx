...
The <Link path="get_started/quick-start">workspace configuration</Link> above is enough to build with. Install a plugin or power as well if you want the MCP server available across all of your projects:
