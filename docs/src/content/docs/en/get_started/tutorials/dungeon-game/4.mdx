...
:::tip
You can run Nx commands instead to start any connected API local servers, allowing you to iterate on both your tRPC API and your website together. <NxCommands commands={["run @dungeon-adventure/game-ui:serve-local"]} env={{RUNTIME_CONFIG_APP_ID:"xxxx"}} />
