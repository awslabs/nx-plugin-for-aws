...
We are going to start by implementing our Game API. To do this, we need to create 5 API's in total:
...
5. `queryInventory` - this will return a paginated list of items in a player's inventory.
