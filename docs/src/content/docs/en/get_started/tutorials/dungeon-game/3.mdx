...
<Aside type="caution">
Ensure your AWS account has enabled access to the [Strands default model](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/amazon-bedrock/) within Bedrock for your target region. Refer to the instructions outlined in [this guide](https://docs.aws.amazon.com/bedrock/latest/userguide/model-access-modify.html). At the time of writing this is Anthropic Claude Sonnet 4.
</Aside>
