...
- React/Vite frontend website utilising:
  ...
  - [shadcn/ui](https://ui.shadcn.com/) for UI primitives and theming.
  - [CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/) for the chat experience, talking to the agent directly.
...
- [Strands](https://strandsagents.com/) Agent exposed via the AG-UI protocol and hosted on [Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/). Chat history is persisted automatically per session by AgentCore Runtime.
