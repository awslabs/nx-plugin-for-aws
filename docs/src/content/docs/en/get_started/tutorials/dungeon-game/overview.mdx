...
- [Docker](https://www.docker.com/) (or another container engine such as [Finch](https://github.com/runfinch/finch)) is required for local DynamoDB development and for building the AgentCore components
