...
:::tip
`schema` and `backend` are both TypeScript projects, so you can refer to the [TypeScript project documentation](/guides/typescript-project) for more details about their general usage.
:::
