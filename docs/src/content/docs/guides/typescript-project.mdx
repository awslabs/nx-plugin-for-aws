...
:::tip
If you are a VSCode user, we recommend installing the [Vitest Runner for VSCode that actually work](https://marketplace.visualstudio.com/items?itemName=rluvaton.vscode-vitest) extension, which allows you to run, watch or debug tests from your IDE.
:::
