...
Esegui il <Link path="/guides/react-website">generatore `ts#website`</Link> per configurare il progetto del sito web in `packages/website`:

<RunGenerator generator="ts#website" noInteractive requiredParameters={{ name: 'website' }} />
