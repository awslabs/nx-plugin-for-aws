...
L'ARN del runtime AgentCore dell'agente remoto viene automaticamente registrato nel namespace `connection` della <Link path="guides/runtime-config">Runtime Configuration</Link> dal costrutto CDK generato, in modo che l'agente host possa scoprirlo a runtime.
</Fragment>
...
L'ARN del runtime AgentCore dell'agente remoto viene automaticamente registrato nel namespace `connection` della <Link path="guides/runtime-config">Runtime Configuration</Link> dal modulo Terraform generato, in modo che l'agente host possa scoprirlo a runtime.
</Fragment>
</Infrastructure>