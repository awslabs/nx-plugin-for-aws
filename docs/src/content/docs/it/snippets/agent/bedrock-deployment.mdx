...
Quando selezioni l'autenticazione `Cognito`, il generatore crea automaticamente il costrutto `UserIdentity` e configura l'agent per utilizzare Cognito per l'autenticazione.
