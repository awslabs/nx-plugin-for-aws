...
Potresti voler limitare questo ai modelli specifici utilizzati dal tuo agent. Gli agent Strands utilizzano [Claude 4 Sonnet come modello predefinito](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/amazon-bedrock/#default-model); consulta la [guida ai provider di modelli Strands](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/) per configurare un modello diverso.

<Infrastructure>
<Fragment slot="cdk">
Per limitare i permessi, modifica il costrutto CDK dell'agent generato e sostituisci le risorse `PolicyStatement` predefinite con gli ARN dei modelli fondazionali o profili di inferenza specifici che utilizzi.
</Fragment>
<Fragment slot="terraform">
Per limitare i permessi, modifica il modulo Terraform dell'agent generato e sostituisci gli ARN `Resource` del modello bedrock predefiniti con gli ARN dei modelli fondazionali o profili di inferenza specifici che utilizzi.
</Fragment>
</Infrastructure>
:::
