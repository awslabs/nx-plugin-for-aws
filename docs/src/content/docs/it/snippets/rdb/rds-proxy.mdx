...
L'infrastruttura generata include un [RDS Proxy](https://aws.amazon.com/rds/proxy/) per impostazione predefinita, che si posiziona tra l'applicazione e il cluster Aurora. RDS Proxy offre diversi vantaggi:
