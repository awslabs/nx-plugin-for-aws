...
- [Docker](https://www.docker.com/) è necessario per alcuni generatori. Utenti Windows: consultare la <Link path="get_started/windows-setup">guida di configurazione per Windows</Link>.
