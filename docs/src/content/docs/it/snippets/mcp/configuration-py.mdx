...
:::tip
Alcuni assistenti AI, come Kiro, consentono di specificare una configurazione del server MCP a livello di workspace, particolarmente utile per definire i server MCP rilevanti per un progetto specifico.
:::