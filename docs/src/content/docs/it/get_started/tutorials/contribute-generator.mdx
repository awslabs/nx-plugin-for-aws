...
Se hai completato il <Link path="get_started/tutorials/dungeon-game/overview">tutorial dungeon adventure</Link>, o hai già un altro workspace Nx esistente che utilizza un'API tRPC, puoi saltare questo passaggio.
:::
