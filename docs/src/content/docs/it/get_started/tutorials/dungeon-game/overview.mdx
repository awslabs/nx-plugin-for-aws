...
- [Docker](https://www.docker.com/) (o un altro motore di container come [Finch](https://github.com/runfinch/finch)) è richiesto per lo sviluppo locale di DynamoDB e per la costruzione dei componenti AgentCore

:::tip[Configurazione dell'assistente IA]
Se utilizzi un assistente AI come Kiro, Kiro CLI, Cursor, Claude Code o Cline, consulta la pagina <Link path="/get_started/building-with-ai">installazione del server MCP Nx Plugin for AWS</Link>.
:::