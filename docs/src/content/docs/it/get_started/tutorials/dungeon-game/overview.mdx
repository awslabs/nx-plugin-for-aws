...
<Aside>Questo tutorial è pensato per chi preferisce imparare facendo e vuole realizzare rapidamente qualcosa di tangibile. Se preferisci apprendere ogni concetto passo dopo passo, consulta le guide dei singoli componenti utilizzando la navigazione a sinistra.</Aside>
...
:::tip
Se utilizzi un assistente AI come Kiro, Amazon Q Developer, Cursor, Claude Code o Cline, consulta la pagina <Link path="/get_started/building-with-ai">installazione del plugin Nx per AWS MCP server</Link>.
:::