...
- Frontend React/Vite che utilizza:
  ...
  - [shadcn/ui](https://ui.shadcn.com/) per primitive UI e tematizzazione.
  - [CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/) per l'esperienza di chat, comunicando direttamente con l'agent.
...
- Agent [Strands](https://strandsagents.com/) esposto tramite il protocollo AG-UI e ospitato su [Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/). La cronologia delle chat viene persistita automaticamente per sessione da AgentCore Runtime.
