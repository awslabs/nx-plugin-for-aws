...
Ecco l'elenco di tutti i file generati dal generatore `ts#react-website`. Esamineremo alcuni file chiave evidenziati nell'albero:
<FileTree>
- packages/
  - common/
    - constructs/
...
Ecco l'elenco di tutti i file generati/aggiornati dal generatore `ts#react-website#auth`. Esamineremo alcuni file chiave evidenziati nell'albero:
<FileTree>
- packages/
  - common/
    - constructs/
