...
Di seguito è riportato l'elenco di tutti i file generati dal generatore `ts#cloudscape-website`. Esamineremo alcuni dei file chiave evidenziati nell'albero delle directory:
<FileTree>
- packages/
  - common/
    - constructs/
...
Di seguito è riportato l'elenco di tutti i file generati/aggiornati dal generatore `ts#cloudscape-website#auth`. Esamineremo alcuni dei file chiave evidenziati nell'albero delle directory:
<FileTree>
- packages/
  - common/
    - constructs/
