...
:::note
Consulta la <Link path="guides/workspace">Guida alla Workspace</Link> per i dettagli completi sulle opzioni della workspace, la struttura e i comandi comuni.
:::
