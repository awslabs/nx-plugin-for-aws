...
## Step 1: Inizializzare una Nuova Area di Lavoro Nx

Esegui il seguente comando per creare un'area di lavoro Nx con il package manager che preferisci:
...
Successivamente, esegui questo comando per costruire il progetto:
