---
title: 'Plugin Nx per AWS - @aws/nx-plugin'
...
##### Inizia con un vantaggio grazie a un'applicazione completamente strutturata

<CardGrid className="foo">
  <Card title="Aggiungi componenti al tuo progetto">
    <Icon name="puzzle" size="100px"/>
  </Card>
  <Card title="Condividi codice e collabora senza intoppi">
