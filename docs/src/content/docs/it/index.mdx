---
title: '@aws/nx-plugin'
description: "Avvia e costruisci progetti AWS facilmente (con plugin NX)"
template: splash
hero:
  tagline: "Avvia e costruisci progetti AWS facilmente (con plugin NX)"
  image:
...
<CardGrid className="foo">
  ...
  <Card title="Personalizza i tuoi progetti come preferisci">
...
<div class="container">
  ##### Grazie ai nostri fantastici contributor!
