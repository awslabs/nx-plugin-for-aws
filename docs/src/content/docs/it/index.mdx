...
<div class="landing-section landing-carousel-section">
  ...
  <p class="landing-lede">
    Ogni generatore produce codice applicativo basato sulle best practice <em>e</em> l'infrastruttura per distribuirlo, avvicinandoti alla produzione. Eseguili in modo interattivo — ti verranno richiesti i valori necessari.
  </p>
  <GeneratorCarousel />
</div>
