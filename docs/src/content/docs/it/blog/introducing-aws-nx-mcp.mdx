...
Se siete interessati a esplorare lo sviluppo AWS assistito da AI con più struttura e affidabilità, provate il Nx Plugin per AWS MCP Server. Potete configurarlo nel vostro assistente AI preferito (Kiro, Kiro CLI, Cline, Claude Code, ecc.) con la seguente configurazione del server MCP:
