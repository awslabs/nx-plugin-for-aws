...
Il target chat funziona in modo autonomo — **non** avvia l'agente per te. Per impostazione predefinita si connette al tuo agente in esecuzione localmente, quindi avvia prima `<your-agent-name>-serve-local` (in un terminale separato):
