...
<CardGrid>
  <ConnectionCard
    ...
    description="Chiama un Python Agent da un sito web React"
  ...
  <ConnectionCard
    ...
    description="Chiama un Agent che espone il protocollo AG-UI da un sito web React tramite CopilotKit"
  ...
  <ConnectionCard
    ...
    description="Connetti un Python Agent a una tabella DynamoDB"
