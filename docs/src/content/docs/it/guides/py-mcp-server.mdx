...
Se hai selezionato `None` per `computeType`, non vengono generati costrutti CDK o moduli Terraform — il server MCP è configurato solo per uso locale STDIO / HTTP.
</OptionFilter>
