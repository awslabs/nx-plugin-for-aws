...
Il generatore crea un <Link path="/guides/typescript-project">progetto TypeScript</Link> autonomo contenente i Lambda handler e l'infrastruttura per distribuirli in base al tuo `iac` selezionato.
