...
:::tip
Se desideri un'esperienza simile al <Link path="/guides/api-connection">generatore di connessione API</Link> per gli agenti, metti +1 a [questa issue di GitHub](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::