...
Hai selezionato `None` per `computeType`, quindi non vengono generati costrutti CDK o moduli Terraform — lo Strands Agent può essere eseguito solo localmente.
</OptionFilter>
