...
:::tip
Per una configurazione semplificata, utilizza il <Link path="/guides/connection/react-strands-agent">generatore Connection</Link> per connettere il tuo sito web React a uno Strands Agent, che configura automaticamente il client tRPC WebSocket con l'autenticazione corretta.
