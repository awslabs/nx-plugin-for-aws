...
- src
  - components
    - \<ApiName>ClientProvider.tsx Configura i client tRPC e i binding per gli schemi backend. ApiName corrisponderà al nome dell'API
...
Gestisci sempre gli stati di caricamento ed errore per una migliore user experience:
