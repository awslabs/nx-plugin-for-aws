...
3. Cognito Auth aggiunto tramite il <Link path="/guides/react-website-auth">generatore `ts#react-website-auth`</Link> se si connette un'API che utilizza autenticazione Cognito o IAM
