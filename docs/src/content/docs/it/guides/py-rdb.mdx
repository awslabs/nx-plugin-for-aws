...
Per immagini container basate su Debian, aggiungi il bundle CA di Amazon RDS al trust store di sistema:
...
Per immagini container basate su Amazon Linux, utilizza invece il comando `update-ca-trust`:
