...
`my_scope_my_db` è il nome del modulo del tuo progetto database — un singolo modulo flat denominato `<scope>_<name>`, visibile come directory del package all'interno del progetto.
