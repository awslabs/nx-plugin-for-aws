...
Gli handler di migrazione del database e create-db-user vengono eseguiti come immagini container costruite durante il `build` del tuo progetto. Queste immagini vengono scansionate per vulnerabilità come descritto di seguito.
