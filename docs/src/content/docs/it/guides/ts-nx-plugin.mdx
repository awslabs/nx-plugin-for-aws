...
- your-plugin/
  ...
  - package.json Configurazione del package del plugin
...
Dopo aver creato il progetto del plugin, puoi aggiungere generatori usando <Link path="/guides/ts-nx-generator">`ts#nx-generator`</Link>:
...
Leggi la guida <Link path="/guides/nx-generator">`ts#nx-generator`</Link> per dettagli sull'implementazione dei generatori.
:::
