...
Le migrazioni sono raggruppate per giorno in cui sono state create, in modo che il loro ordine approssimativo rimanga visibile a colpo d'occhio man mano che la collezione cresce.
