...
4. Cognito Auth aggiunto tramite il <Link path="/guides/react-website-auth">generatore `ts#website#auth`</Link> se si connette un'API che utilizza l'autenticazione Cognito o IAM
