...
ta. Il gateway locale inoltra i percorsi `/<targetName>/...` al server locale di ciascun agent, corrispondendo al routing basato su percorso del Gateway distribuito.
di ciascun agent, corrispondendo al routing basato su percorso del Gateway distribuito.
'agent.
