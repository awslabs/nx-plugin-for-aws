...
Il generatore `connection` collega un <Link path="guides/ts-agent">TypeScript Strands Agent</Link> a un progetto <Link path="guides/ts-rdb">Relational Database</Link>, rendendo disponibile un client Prisma all'interno della tua agent factory.
