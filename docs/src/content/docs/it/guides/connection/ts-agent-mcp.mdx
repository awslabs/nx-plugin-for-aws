...
Questo avvierà sia l'agente che tutti i server MCP connessi, con l'agente che si connette ai server MCP direttamente tramite HTTP sulle loro porte locali assegnate.e.