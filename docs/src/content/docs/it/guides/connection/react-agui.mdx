...
:::note
AG-UI è supportato sia per TypeScript che per Python Agents. Usa il generatore <Link path="guides/ts-agent">`ts#agent`</Link> o <Link path="guides/py-agent">`py#agent`</Link> con `protocol=AG-UI`.
:::
...
- <Link path="guides/connection/react-ts-agent">Guida React to TypeScript Agent (HTTP)</Link>
- <Link path="guides/connection/react-py-agent">Guida React to Python Agent (HTTP)</Link>
