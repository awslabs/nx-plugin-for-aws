---
title: Sito Web React ad AgentCore Gateway
...
Per ogni agente Python HTTP esposto, vengono generati gli stessi file della <Link path="guides/connection/react-py-agent">connessione React ad agente Python</Link> (un client OpenAPI type-safe, hook e un provider), con l'URL base del client instradato attraverso il Gateway.
...
Concedi agli utenti autenticati del sito web il permesso di invocare il Gateway:
