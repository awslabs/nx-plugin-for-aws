...
Il generatore `connection` può connettere il tuo <Link path="guides/py-agent">Python Strands Agent</Link> a un server MCP (sia <Link path="guides/ts-mcp-server">TypeScript</Link> che <Link path="guides/py-mcp-server">Python</Link>).
...
1. Un progetto Python con un componente <Link path="guides/py-agent">Strands Agent</Link>
