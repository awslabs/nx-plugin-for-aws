...
1. Un progetto Python con un componente <Link path="guides/py-agent">Agent</Link>
...
- packages/common/agent\_connection
  - \<scope>\_agent\_connection
    ...
    - app
      - \<mcp\_server\_name>\_client\_strands.py Client Strands per-connessione per ogni server MCP
