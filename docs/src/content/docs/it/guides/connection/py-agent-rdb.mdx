...
Il generatore `connection` collega un <Link path="guides/py-agent">Python Agent</Link> a un progetto <Link path="guides/py-rdb">Python Relational Database</Link>, rendendo la sessione del database disponibile all'interno degli strumenti del tuo agent.
