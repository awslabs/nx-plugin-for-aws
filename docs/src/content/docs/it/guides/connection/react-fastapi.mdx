...
Se stai lavorando contemporaneamente all'applicazione React e al FastAPI, utilizza il target `dev` dell'applicazione React che rigenererà automaticamente il client quando l'API cambia, oltre a effettuare l'hot-reload del sito e del server FastAPI locale:
