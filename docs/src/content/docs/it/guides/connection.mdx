...
Preferisci progettare prima il tuo workspace? Il <Link path="get_started/graph-builder">Graph Builder</Link> ti permette di trascinare i progetti e disegnare le connessioni tra di essi, quindi ti fornisce i comandi per creare tutto.
:::
...
<CardGrid>
  ...
  <ConnectionCard
    ...
    description="Collega un TypeScript MCP Server a un database relazionale Aurora"
  ...
  <ConnectionCard
    ...
    description="Collega un FastAPI a un database relazionale Python Aurora"
  ...
  <ConnectionCard
    ...
    description="Collega un Python Agent a un database relazionale Python Aurora"
  ...
  <ConnectionCard
    ...
    description="Collega un Python MCP Server a un database relazionale Python Aurora"
  ...
  <ConnectionCard
    ...
    description="Collega un TypeScript MCP Server a una tabella DynamoDB"
  ...
  <ConnectionCard
    ...
    description="Esponi un agente con un AgentCore Gateway come target di runtime"
  ...
  <ConnectionCard
    ...
    description="Collega un sito React agli agenti tramite un AgentCore Gateway"
