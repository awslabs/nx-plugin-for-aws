...
:::tip[Sviluppo Locale]
I progetti connessi possono essere eseguiti sulla tua macchina con i target `serve` e `serve-local`. Consulta la guida <Link path="guides/local-development">Sviluppo Locale</Link> per maggiori dettagli.
:::
