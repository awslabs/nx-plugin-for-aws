...
:::caution[Windows]
`mise` non pubblica alcun pacchetto Windows su npm, quindi installa la Smithy CLI manualmente prima di eseguire la build:
...
Consulta la [guida all'installazione della Smithy CLI](https://smithy.io/2.0/guides/smithy-cli/cli_installation.html) per altre opzioni.
:::
