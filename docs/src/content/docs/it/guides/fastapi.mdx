...
<OptionFilter when={{ computeType: 'ServerlessApiGatewayRestApi' }} description="Streaming — solo REST API">
### Streaming
...
<OptionFilter when={{ auth: 'Cognito' }} description="Configurazione del costrutto identity Cognito">
...
<OptionFilter when={{ auth: 'Cognito' }} description="Configurazione del modulo Cognito">
:::note[Autenticazione Cognito]
...
<OptionFilter when={{ auth: 'Custom' }} description="Errori Checkov previsti quando auth=None">
