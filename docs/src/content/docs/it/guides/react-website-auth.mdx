...
A differenza delle opzioni `enableWaf` e MFA di seguito, la modalità di applicazione non è esposta come prop o variabile, quindi questa modifica si applica a ogni `UserIdentity` nel tuo workspace.
