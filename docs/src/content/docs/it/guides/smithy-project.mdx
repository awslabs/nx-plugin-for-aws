...
I progetti Smithy vengono costruiti utilizzando [Docker](https://www.docker.com/), che esegue la [Smithy CLI](https://smithy.io/2.0/guides/smithy-cli/index.html) per validare il tuo modello:
...
equivalenti.
mento alle forme della libreria con `use`:
