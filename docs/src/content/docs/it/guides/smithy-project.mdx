...
Su macOS e Linux la CLI viene risolta da [mise](https://mise.jdx.dev/), che la build recupera su richiesta, quindi non c'è nulla da installare — scarica e memorizza nella cache la versione fissata la prima volta che esegui la build. Su Windows è un prerequisito che installi tu stesso — vedi <Link path="guides/ts-smithy-api#building-on-windows">Building su Windows</Link>.
