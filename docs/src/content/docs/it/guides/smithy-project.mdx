...
[Smithy](https://smithy.io/) è un linguaggio di definizione delle interfacce per descrivere i servizi e i dati che scambiano. Il generatore di progetti Smithy crea un progetto contenente un modello Smithy.
