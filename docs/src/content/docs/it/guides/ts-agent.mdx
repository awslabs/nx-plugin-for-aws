...
Il [protocollo AG-UI](https://docs.ag-ui.com/) non è ancora supportato per TypeScript Agents. Se hai bisogno del supporto AG-UI, utilizza il generatore <Link path="/guides/py-agent">`py#agent`</Link> con `protocol=AG-UI`. Vedi [agents/sdk-typescript#347](https://github.com/agents/sdk-typescript/issues/347) per lo stato del supporto AG-UI per TypeScript.
:::
