...
Se hai selezionato `None` per `computeType`, non vengono generati costrutti CDK o moduli Terraform — lo Agent può essere eseguito solo localmente.
</OptionFilter>
