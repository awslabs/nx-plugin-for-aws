...
Se stai chiamando la tua API da un sito React, considera l'uso del generatore <Link path="guides/connection/react-trpc">API Connection</Link> per configurare il client.
