...
:::note[Sistema di design Cloudscape]
...
:::note[shadcn/ui]
Hai selezionato [shadcn/ui](https://ui.shadcn.com/) come `uxProvider`. I componenti e gli stili generati si affiancano a TanStack Router / Vite — consulta la documentazione Shadcn per aggiungere ulteriori componenti.
:::
</OptionFilter>

<OptionFilter when={{ uxProvider: 'None' }} description="No UX provider — bring your own component library">
:::note[Nessun UX Provider]
Hai selezionato `None` per `uxProvider`, quindi nessuna libreria di componenti o sistema di design è configurato. Sei libero di aggiungere la libreria di componenti che preferisci.
:::
</OptionFilter>
