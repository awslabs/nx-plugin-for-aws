...
<CardGrid>
  <ConnectionCard
    ...
    description="Connetti un Agent TypeScript a un server MCP"
  ...
  <ConnectionCard
    ...
    description="Connetti un Agent Python a un server MCP"
  ...
  <ConnectionCard
    ...
    description="Connetti un Server MCP TypeScript a un database relazionale Aurora"
  ...
  <ConnectionCard
    ...
    description="Connetti un Server MCP TypeScript a una tabella DynamoDB"
  ...
  <ConnectionCard
    ...
    description="Aggrega un server MCP dietro un Gateway AgentCore"
