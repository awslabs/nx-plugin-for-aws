...
Aggiunge un [Nx Generator](https://nx.dev/recipes/generators/local-generators) a un progetto TypeScript, per aiutarti ad automatizzare task ripetitivi come la creazione di componenti o l'imposizione di strutture di progetto specifiche.
...
:::tip
Puoi provare i pattern GritQL nel [GritQL Playground](https://docs.grit.io/playground), oppure installare la CLI GritQL localmente per testare i pattern sui tuoi file:
