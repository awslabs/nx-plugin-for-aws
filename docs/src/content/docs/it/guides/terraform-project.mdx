...
Un progetto senza file di test è un successo senza operazioni, quindi puoi aggiungere test quando ne hai bisogno. Questo target non fa parte di `build`, poiché l'esecuzione dei test scarica i provider — invocalo direttamente o da CI dove Terraform è disponibile.
