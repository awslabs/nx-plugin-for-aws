...
| `translationCommitMessage` | Marcatore del messaggio di commit per i commit di traduzione. Non presente nella configurazione generata — aggiungi la chiave per sovrascrivere il valore predefinito `docs: update translations`. |
