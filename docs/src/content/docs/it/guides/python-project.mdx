...
I file di test sono esclusi dall'input denominato `production` in `nx.json`, che copre la directory `tests` così come i file `test_*.py`, `*_test.py` e `conftest.py` ovunque nel tuo progetto.
