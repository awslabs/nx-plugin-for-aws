...
I progetti Python utilizzano [ty](https://docs.astral.sh/ty/) per il controllo dei tipi.
...
Per configurare il comportamento del controllo dei tipi nel tuo progetto, aggiungi una sezione `[tool.ty]` al file `pyproject.toml` del progetto. Consulta il [riferimento alla configurazione di ty](https://docs.astral.sh/ty/reference/configuration/) per le opzioni disponibili.
