...
La migrazione del database viene eseguita come immagine container costruita durante il `build` del tuo progetto. Questa immagine viene scansionata per vulnerabilità come descritto di seguito.
