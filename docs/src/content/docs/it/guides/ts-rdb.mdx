...
- <Link path="guides/connection/ts-agent-rdb">Agente TypeScript → Database Relazionale</Link>
...
L'immagine del database locale è configurata nel campo `serveLocal.image` del file `config.json` generato nella radice del tuo progetto database. Aggiorna quel valore quando modifichi le versioni del motore.
