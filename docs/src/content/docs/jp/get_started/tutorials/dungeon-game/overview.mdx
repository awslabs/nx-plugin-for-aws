...
- React/Viteフロントエンドウェブサイト（以下を活用）：
  ...
  - UIプリミティブとテーマのための[shadcn/ui](https://ui.shadcn.com/)
  - エージェントと直接対話するチャット体験のための[CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/)
...
- AG-UIプロトコル経由で公開され、[Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/)上でホストされる[Strands](https://strandsagents.com/)エージェント。チャット履歴はAgentCore Runtimeによってセッションごとに自動的に永続化されます。
