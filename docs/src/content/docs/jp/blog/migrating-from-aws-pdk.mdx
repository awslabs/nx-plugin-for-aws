...
:::caution[特定時点のガイド]
このガイドは特定の時点での内容を記載しており、Nx Plugin for AWSの進化に伴って更新されない可能性があります。これを補うため、ガイド内では`@aws/nx-plugin`のバージョンを`1.0.0-rc.33`に固定しています。最新版での実行も可能ですが、ガイドとの差異が生じる可能性があります。
:::
