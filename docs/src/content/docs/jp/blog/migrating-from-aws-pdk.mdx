...
<Snippet name="pdk-migration/faq/use-of-projen" parentHeading="Use of Projen" />orkspaceCommand workspace="my-project" />
...
<Snippet name="pdk-migration/faq/use-of-projen" parentHeading="Use of Projen" />ng="Use of Projen" />