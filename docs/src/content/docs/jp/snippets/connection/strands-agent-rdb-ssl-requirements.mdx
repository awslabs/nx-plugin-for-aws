...
詳細については、[Amazon RDS SSL/TLS ドキュメント](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.html)を参照してください。RDS Proxyを使用する場合、`NODE_EXTRA_CA_CERTS` を設定する必要はありません。
