...
<CardGrid>
  <ConnectionCard
    ...
    description="tRPC APIをAuroraリレーショナルデータベースに接続"
  ...
  <ConnectionCard
    ...
    description="TypeScript AgentをAuroraリレーショナルデータベースに接続"
  ...
  <ConnectionCard
    ...
    description="TypeScript MCP ServerをAuroraリレーショナルデータベースに接続"
