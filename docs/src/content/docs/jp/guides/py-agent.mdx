...
Strandsエージェントの詳細な作成方法は[Strandsドキュメント](https://strandsagents.com/docs/user-guide/quickstart/overview/)を参照してください。LangChainエージェントの場合、[`connection`ジェネレーター](/guides/connection/py-agent-mcp)もMCPサーバーとA2Aエージェントツールを`create_agent`に接続します。
