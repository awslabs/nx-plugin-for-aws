...
<Link path="guides/connection">`connection`</Link>ジェネレーターを使用して、このプロジェクトをワークスペース内の他のプロジェクトと統合します。以下の接続がこのプロジェクトに関連しています：
...
<CardGrid>
  ...
  <ConnectionCard
    ...
    description="Python AgentをMCPサーバーに接続"
  ...
  <ConnectionCard
    ...
    description="Python AgentをリモートA2Aエージェントに接続"
  ...
  <ConnectionCard
    ...
    description="TypeScript AgentをリモートA2Aエージェントに接続"
  ...
  <ConnectionCard
    ...
    description="Python AgentをDynamoDBテーブルに接続"
  ...
  <ConnectionCard
    ...
    description="Python AgentをAgentCore Gatewayに接続"
