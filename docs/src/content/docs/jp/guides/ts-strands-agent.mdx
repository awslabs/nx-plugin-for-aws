...
:::tip
エージェント用の <Link path="/guides/connection">API connection ジェネレーター</Link>と同様のエクスペリエンスをご希望の場合は、[この GitHub issue](https://github.com/awslabs/nx-plugin-for-aws/issues/326) に +1 してください。
:::