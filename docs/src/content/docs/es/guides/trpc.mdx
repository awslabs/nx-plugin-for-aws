...
Si estás llamando a tu API desde un sitio web React, considera usar el generador de <Link path="/guides/connection/react-trpc">Connection</Link> para configurar el cliente.
