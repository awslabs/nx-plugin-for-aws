...
Si estás llamando a tu API desde un sitio web React, considera usar el generador <Link path="guides/connection/react-trpc">Conexión de API</Link> para configurar el cliente.
