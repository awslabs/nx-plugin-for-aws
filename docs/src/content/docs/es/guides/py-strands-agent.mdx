...
Los agentes AG-UI pueden conectarse a un frontend React usando el <Link path="/guides/connection/react-agui">generador de conexión `react` → agente AG-UI</Link>, que configurará los componentes de [CopilotKit](https://docs.copilotkit.ai/aws-strands) para una experiencia de chat enriquecida.
:::
...
:::tip[Conectar a un sitio web React]
Los agentes AG-UI están diseñados para ser consumidos directamente por un frontend. Usa el <Link path="/guides/connection/react-agui">generador de conexión `react` → agente AG-UI</Link> para conectar tu sitio web React al agente con un proveedor de [CopilotKit](https://docs.copilotkit.ai/aws-strands) y un cliente [AG-UI HttpAgent](https://docs.ag-ui.com/).
:::
