...
<CardGrid>
  <ConnectionCard
    ...
    description="Llamar a un TypeScript Agent desde un sitio web React"
  ...
  <ConnectionCard
    ...
    description="Llamar a un Agent que expone el protocolo AG-UI desde un sitio web React a través de CopilotKit"
  ...
  <ConnectionCard
    ...
    description="Conectar un TypeScript Agent a un servidor MCP"
  ...
  <ConnectionCard
    ...
    description="Conectar un TypeScript Agent a un agente A2A remoto"
  ...
  <ConnectionCard
    ...
    description="Conectar un Python Agent a un agente A2A remoto"
  ...
  <ConnectionCard
    ...
    description="Conectar un TypeScript Agent a una base de datos relacional Aurora"
  ...
  <ConnectionCard
    ...
    description="Conectar un TypeScript Agent a una tabla DynamoDB"
  ...
  <ConnectionCard
    ...
    description="Conectar un TypeScript Agent a un AgentCore Gateway"
