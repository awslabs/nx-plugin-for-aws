...
Si seleccionaste `None` para `computeType`, no se generan constructos CDK ni módulos Terraform — el Agent solo puede ejecutarse localmente.
</OptionFilter>
