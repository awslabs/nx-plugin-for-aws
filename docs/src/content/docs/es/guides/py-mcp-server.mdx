...
Use el generador <Link path="guides/connection">`connection`</Link> para integrar este proyecto con otros en su espacio de trabajo. Las siguientes conexiones involucran este proyecto:
