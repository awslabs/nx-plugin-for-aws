...
El generador crea un <Link path="/guides/typescript-project">proyecto TypeScript</Link> independiente que contiene los manejadores Lambda, e infraestructura para desplegarlos según tu `iac` seleccionado.
