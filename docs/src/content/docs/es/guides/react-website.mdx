...
El generador crea infraestructura CDK o Terraform según tu `iac`. Úsala para desplegar tu sitio.
...
<Fragment slot="terraform">
Recomendamos usar el generador <Link path="/guides/terraform-project">`terraform#project`</Link> para crear un proyecto Terraform.
