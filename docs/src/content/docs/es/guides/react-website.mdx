...
<CardGrid>
  <ConnectionCard
    title="React to tRPC"
    description="Llamar a una API tRPC desde un sitio web React"
  ...
  <ConnectionCard
    ...
    description="Llamar a una API Smithy desde un sitio web React"
  ...
  <ConnectionCard
    ...
    description="Llamar a un Agente Python desde un sitio web React"
  ...
  <ConnectionCard
    ...
    description="Llamar a un Agente TypeScript desde un sitio web React"
  ...
  <ConnectionCard
    ...
    description="Llamar a un Agente que expone el protocolo AG-UI desde un sitio web React vía CopilotKit"
