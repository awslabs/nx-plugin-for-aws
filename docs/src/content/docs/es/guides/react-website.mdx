...
:::note
Con CDK, el construct del sitio web puede declararse en cualquier punto de tu stack. La configuración en tiempo de ejecución se resuelve de forma diferida en el momento de sintetización, por lo que todos los valores se incluirán independientemente del orden de declaración.
:::
</Fragment>
<Fragment slot="terraform">
...
:::caution
Debes declarar tu módulo del sitio web _después_ de cualquier módulo que añada a la configuración y configurar `depends_on` apropiado para garantizar el orden, de lo contrario faltarán valores en `runtime-config.json`.
:::
</Fragment>
</Infrastructure>
