...
:::note[Sistema de diseño Cloudscape]
...
:::note[shadcn/ui]
Seleccionaste [shadcn/ui](https://ui.shadcn.com/) como tu `uxProvider`. Los componentes y estilos generados se encuentran junto a TanStack Router / Vite — consulta la documentación de Shadcn para agregar más componentes.
:::
</OptionFilter>

<OptionFilter when={{ uxProvider: 'None' }} description="No UX provider — bring your own component library">
:::note[Sin proveedor de UX]
Seleccionaste `None` para `uxProvider`, por lo que no se incluye ninguna biblioteca de componentes o sistema de diseño. Eres libre de agregar la biblioteca de componentes de tu elección.
:::
</OptionFilter>
