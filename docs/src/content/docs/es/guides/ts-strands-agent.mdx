...
:::tip
Para una configuración simplificada, usa el <Link path="/guides/connection/react-strands-agent">Generador de conexión</Link> para conectar tu sitio web React a un Strands Agent, que configura automáticamente el cliente tRPC WebSocket con la autenticación correcta.
