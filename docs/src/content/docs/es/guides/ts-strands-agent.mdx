...
:::tip
Si deseas una experiencia similar al <Link path="/guides/api-connection">generador de conexión API</Link> para agentes, por favor +1 [este issue de GitHub](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::