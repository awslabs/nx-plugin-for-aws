...
:::tip
Se recomienda especificar modelos de respuesta para tus operaciones API si planeas usar el generador `connection`. <Link path="guides/connection/react-fastapi#errors">Consulta aquí para más detalles</Link>.
:::
