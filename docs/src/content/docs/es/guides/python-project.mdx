...
Los archivos de prueba se excluyen de la entrada nombrada `production` en `nx.json`, que cubre el directorio `tests` así como los archivos `test_*.py`, `*_test.py` y `conftest.py` en cualquier lugar de tu proyecto.
