...
`synth` depende de `^assemble` en lugar de `^build`, por lo que sintetizar construye los artefactos que tus stacks despliegan — los bundles de Lambda, imágenes de contenedor y especificaciones generadas — sin ejecutar también las compuertas de lint, prueba y verificación de tipos de cada proyecto upstream. Consulta <Link path="guides/typescript-project#ensamblar">Ensamblar</Link> para ver cómo `assemble` se relaciona con `build`.
...
Para obtener más información sobre CDK, consulta la [Guía del Desarrollador de CDK](https://docs.aws.amazon.com/cdk/v2/guide/core_concepts.html) y la [Referencia de API](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-construct-library.html).sarrollador de CDK](https://docs.aws.amazon.com/cdk/v2/guide/core_concepts.html) y la [Referencia de API](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-construct-library.html).