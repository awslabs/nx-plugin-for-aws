...
¿Prefieres diseñar tu espacio de trabajo primero? El <Link path="get_started/graph-builder">Graph Builder</Link> te permite arrastrar proyectos y dibujar las conexiones entre ellos, y luego te proporciona los comandos para crear todo el conjunto.
:::
...
<CardGrid>
  ...
  <ConnectionCard
    ...
    description="Antepone un agente con un AgentCore Gateway como destino de tiempo de ejecución"
