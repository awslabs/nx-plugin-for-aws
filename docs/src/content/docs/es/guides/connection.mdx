...
Los proyectos conectados se pueden ejecutar en tu máquina con los targets `serve` y `serve-local`. Consulta la guía de <Link path="guides/local-development">Desarrollo Local</Link> para más detalles.
:::
