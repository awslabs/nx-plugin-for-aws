...
Para tipos de proyectos específicos, utiliza el generador `connection` para conectar automáticamente las dependencias de desarrollo local de modo que DynamoDB Local se inicie automáticamente junto con tu proyecto, y agregar el paquete DynamoDB como una dependencia del espacio de trabajo:
