...
leto desde la perspectiva del usuario que actualiza — incluyendo salida de ejemplo para migraciones deterministas y agénticas — consulta <Link path="get_started/upgrading">Actualizar Tu Workspace</Link>.
