...
Si estás trabajando simultáneamente en tu aplicación React y FastAPI, usa el target `dev` de la aplicación React, que regenerará automáticamente el cliente cuando cambie tu API, además de recargar en caliente tu sitio y el servidor FastAPI local:
