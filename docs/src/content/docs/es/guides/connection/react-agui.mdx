...
AG-UI y AgentCore Runtime identifican una conversación de manera diferente, y el hook generado los une:
...
Ambos valores provienen del navegador, por lo que nombran una conversación sin decir de quién es. Para restringir cada usuario a sus propias conversaciones, consulta <Link path="guides/ts-agent">Restricción de sesiones a su propietario</Link>.
