...
AG-UI aún no es compatible con TypeScript Strands Agents. Consulta [strands-agents/sdk-typescript#347](https://github.com/strands-agents/sdk-typescript/issues/347) para conocer el estado más reciente. Por ahora, usa el <Link path="guides/py-agent">generador `py#agent`</Link> con `protocol=AG-UI`.
:::
...
2. Un Python Strands Agent con `protocol=AG-UI` (generado usando el <Link path="guides/py-agent">generador `py#agent`</Link>)
...
- <Link path="guides/py-agent">Guía de Python Strands Agent</Link>
- <Link path="guides/connection/react-py-agent">Guía de React a Python Strands Agent (HTTP)</Link>
