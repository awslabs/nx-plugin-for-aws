...
:::note
AG-UI es compatible tanto con TypeScript Agents como con Python Agents. Usa el generador <Link path="guides/ts-agent">`ts#agent`</Link> o <Link path="guides/py-agent">`py#agent`</Link> con `protocol=AG-UI`.
:::
...
- <Link path="guides/connection/react-ts-agent">Guía de React a TypeScript Agent (HTTP)</Link>
- <Link path="guides/connection/react-py-agent">Guía de React a Python Agent (HTTP)</Link>
