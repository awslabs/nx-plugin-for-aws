...
:::note
Al momento de escribir esto, el método `grantInvoke` del agent core runtime aún no incluye este permiso automáticamente (ver [aws-cdk#37495](https://github.com/aws/aws-cdk/issues/37495)).
:::
