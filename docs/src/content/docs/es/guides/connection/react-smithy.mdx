...
Si estás trabajando activamente en tu aplicación React y API Smithy simultáneamente, usa el target `dev` de la aplicación React que regenerará automáticamente el cliente cuando cambie la API, además de recargar en caliente el website y el servidor local de Smithy:
