...
El generador `connection` puede conectar tu <Link path="guides/py-agent">Python Strands Agent</Link> a un servidor MCP (ya sea <Link path="guides/ts-mcp-server">TypeScript</Link> o <Link path="guides/py-mcp-server">Python</Link>).
...
1. Un proyecto Python con un componente <Link path="guides/py-agent">Strands Agent</Link>
