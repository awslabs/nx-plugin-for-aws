...
2. Un TypeScript Strands Agent (generado usando el <Link path="guides/ts-agent">generador `ts#agent`</Link>)
...
- <Link path="guides/ts-agent">Guía de TypeScript Strands Agent</Link>
