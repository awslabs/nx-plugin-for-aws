...
4. Cognito Auth agregado a través del <Link path="/es/guides/react-website-auth">generador `ts#website#auth`</Link> si conectas una API que usa autenticación Cognito o IAM
