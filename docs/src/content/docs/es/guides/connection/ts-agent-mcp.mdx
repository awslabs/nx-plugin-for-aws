...
El generador `connection` puede conectar tu <Link path="guides/ts-agent">TypeScript Strands Agent</Link> a un servidor MCP (ya sea <Link path="guides/ts-mcp-server">TypeScript</Link> o <Link path="guides/py-mcp-server">Python</Link>).
