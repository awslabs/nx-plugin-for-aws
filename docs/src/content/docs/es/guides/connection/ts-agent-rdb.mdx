...
Esto inicia el agente y todas las bases de datos conectadas. La variable de entorno `LOCAL_DEV=true` hace que cada cliente Prisma se conecte a su base de datos Docker local en lugar de Aurora.
