...
A diferencia de las opciones `enableWaf` y MFA a continuación, el modo de aplicación no se expone como una propiedad o variable, por lo que esta edición se aplica a cada `UserIdentity` en tu workspace.
