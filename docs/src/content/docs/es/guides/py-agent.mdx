...
El target de chat se ejecuta de forma independiente. Por defecto se conecta a tu agente ejecutándose localmente, así que primero inicia `<your-agent-name>-serve-local` (en una terminal separada):
...
<CardGrid>
  <ConnectionCard
    title="React a Agente de Python"
    description="Llamar a un Agente de Python desde un sitio web React"
  ...
  <ConnectionCard
    ...
    description="Llamar a un Agente que expone el protocolo AG-UI desde un sitio web React mediante CopilotKit"
    href={`/nx-plugin-for-aws/${Astro.currentLocale || 'es'}/guides/connection/react-agui`}
    source="react"
    target="copilotkit"
  />
  <ConnectionCard
    title="Agente de Python a MCP"
    description="Conectar un Agente de Python a un servidor MCP"
  ...
  />
  <ConnectionCard
    title="Agente de Python a Agente A2A"
    description="Conectar un Agente de Python a un agente A2A remoto"
  ...
  />
  <ConnectionCard
    title="Agente de TypeScript a Agente A2A"
    description="Conectar un Agente de TypeScript a un agente A2A remoto"
  ...
  />
  <ConnectionCard
    title="Agente de Python a DynamoDB de Python"
    description="Conectar un Agente de Python a una tabla DynamoDB"
  ...
  />
  <ConnectionCard
    title="Agente de Python a Gateway de AgentCore"
    description="Conectar un Agente de Python a un Gateway de AgentCore"
