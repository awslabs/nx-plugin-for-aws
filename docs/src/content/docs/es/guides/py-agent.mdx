...
Para una guía detallada sobre cómo escribir agentes Strands, consulta la [documentación de Strands](https://strandsagents.com/docs/user-guide/quickstart/overview/). Para agentes LangChain, el [generador `connection`](/guides/connection/py-agent-mcp) también conecta herramientas de servidores MCP y agentes A2A en `create_agent`.
