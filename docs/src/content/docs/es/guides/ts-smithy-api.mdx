...
:::caution[Windows]
`mise` no publica ningún paquete de Windows en npm, así que instala el Smithy CLI tú mismo antes de construir:
...
Consulta la [guía de instalación del Smithy CLI](https://smithy.io/2.0/guides/smithy-cli/cli_installation.html) para otras opciones.
:::
