...
El CLI se resuelve mediante [mise](https://mise.jdx.dev/), que la construcción obtiene bajo demanda, por lo que no hay nada que instalar — descarga y almacena en caché la versión fijada la primera vez que construyes.
