...
Los manejadores de migración de base de datos y create-db-user se ejecutan como imágenes de contenedor construidas durante el `build` de tu proyecto. Estas imágenes se escanean en busca de vulnerabilidades como se describe a continuación.
