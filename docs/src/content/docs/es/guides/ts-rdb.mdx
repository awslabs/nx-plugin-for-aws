...
La migración de base de datos se ejecuta como una imagen de contenedor construida durante el `build` de tu proyecto. Esta imagen se escanea en busca de vulnerabilidades como se describe a continuación.
