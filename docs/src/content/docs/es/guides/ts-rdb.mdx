...
La imagen de base de datos local se configura en el campo `localDev.image` del archivo `config.json` generado en la raíz de tu proyecto de base de datos. Actualiza ese valor cuando cambies las versiones del motor.
