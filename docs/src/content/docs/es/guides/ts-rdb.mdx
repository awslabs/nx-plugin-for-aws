...
El clúster Aurora exporta los registros de la base de datos a CloudWatch Logs (`postgresql` para PostgreSQL, `error` y `slowquery` para MySQL) y habilita Performance Insights en la instancia de escritura (cifrada con la clave KMS del clúster) para que las consultas sean observables para la resolución de problemas y auditoría. Ten en cuenta que CloudWatch Logs y Performance Insights incurren en costos adicionales.
