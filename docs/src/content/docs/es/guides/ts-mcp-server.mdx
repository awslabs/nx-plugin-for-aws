...
:::tip
Para ejecutar tu servidor MCP (y cualquier dependencia conectada) sin el inspector, usa el objetivo `dev` del proyecto. Si has generado múltiples componentes en el mismo proyecto, ejecuta un solo servidor MCP por sí solo con su objetivo `<your-server-name>-dev`.
:::
