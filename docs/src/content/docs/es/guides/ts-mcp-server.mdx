...
Seleccionaste `None` para `computeType`, por lo que no se generan constructos de CDK ni módulos de Terraform — el servidor MCP está configurado solo para uso local con STDIO / HTTP.
</OptionFilter>
