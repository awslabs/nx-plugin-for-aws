...
Si deseas ejecutar tu servidor MCP localmente usando [transporte HTTP transmisible](https://modelcontextprotocol.io/docs/concepts/transports#streamable-http), puedes usar el objetivo `<your-server-name>-serve-http`.
