...
Esta guía está escrita para un momento específico y probablemente no se actualizará conforme evolucione el Nx Plugin para AWS. Para compensar esto, la guía fija la versión de `@aws/nx-plugin` a `1.0.0-rc.47`. Puedes intentar con la última versión si sigues los pasos, pero puede haber desviaciones respecto a la guía.
:::
