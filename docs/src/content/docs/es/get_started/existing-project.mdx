...
- .mcp.json configura el servidor MCP para agentes de codificación compatibles a menos que esté deshabilitado (también equivalentes .cursor/, .kiro/, .gemini/, .vscode/ y .codex/). Ejecuta el propio `@aws/nx-plugin` del espacio de trabajo, por lo que el servidor siempre coincide con la versión del plugin instalado
</FileTree>
