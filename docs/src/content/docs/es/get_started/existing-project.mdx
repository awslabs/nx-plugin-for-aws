...
- package.json scripts de conveniencia para tareas comunes, además de las dependencias de desarrollo `@aws/nx-plugin`, `@aws/nx-plugin-mcp`, `nx`, `@nx/js`, `@nx/workspace`, `typescript` y Biome
