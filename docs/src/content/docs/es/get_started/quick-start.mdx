...
:::note
Consulta la <Link path="guides/workspace">Guía de Workspace</Link> para obtener detalles completos sobre las opciones del espacio de trabajo, estructura y comandos comunes.
:::
