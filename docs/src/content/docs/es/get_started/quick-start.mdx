...
:::note[Repositorios Git existentes]
Si el directorio del espacio de trabajo ya está dentro de un repositorio Git, la inicialización de Git se omite para que tu repositorio existente permanezca intacto.
:::

:::tip[Elegir un proveedor de IaC]
Se te pedirá que elijas tu proveedor de infraestructura como código (IaC), ya sea [CDK](https://docs.aws.amazon.com/cdk/) o [Terraform](https://developer.hashicorp.com/terraform). Puedes omitir esta pregunta ejecutando el comando con `--iac`, por ejemplo:
