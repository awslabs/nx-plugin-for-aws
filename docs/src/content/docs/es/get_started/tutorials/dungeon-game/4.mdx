...
:::tip
La integración con nuestra Game API ya está configurada, ya que usamos el generador `api-connection`. Si deseas una experiencia similar para agentes, da +1 a [este issue de GitHub](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::
