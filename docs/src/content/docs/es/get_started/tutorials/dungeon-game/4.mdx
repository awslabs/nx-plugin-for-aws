...
Demostremos las capacidades de `@tanstack/react-router` creando una nueva ruta tipada. Para esto, simplemente crea un archivo vacío en la siguiente ubicación: `packages/game-ui/src/routes/game/index.tsx`. Presta atención a los logs del servidor de desarrollo:
...
Si navegas a `http://localhost:4200/game`, ¡verás que se ha renderizado tu nueva página!
