...
Implementaremos nuestra base de datos en DynamoDB y usaremos la biblioteca cliente [ElectroDB](https://electrodb.dev/en/core-concepts/introduction/) para simplificar las cosas. El `queryActions` de la Game API también necesita el cliente S3 para leer los turnos de conversación que el agente ha escrito. Instálalos todos con:
