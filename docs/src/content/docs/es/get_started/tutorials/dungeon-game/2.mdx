...
:::note[Sin procedimiento de historial de chat]
Podrías haber esperado un procedimiento para guardar cada turno de usuario/asistente del chat. No necesitamos uno: el agente AG-UI está alojado en Bedrock AgentCore Runtime, que persiste el historial de conversación por sesión automáticamente siempre que se use el mismo id de hilo.
:::
