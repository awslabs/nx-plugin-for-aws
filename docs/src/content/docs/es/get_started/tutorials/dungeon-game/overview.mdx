...
- [AWS Credentials](https://docs.aws.amazon.com/sdkref/latest/guide/access.html) configuradas para tu cuenta de AWS de destino, ya que este tutorial implementa la aplicación e invoca Amazon Bedrock
