...
- Frontend React/Vite utilizando:
  ...
  - [shadcn/ui](https://ui.shadcn.com/) para primitivas de UI y tematización.
  - [CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/) para la experiencia de chat, hablando directamente con el agente.
...
- Agente [Strands](https://strandsagents.com/) expuesto a través del protocolo AG-UI y alojado en [Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/). El historial de chat se persiste automáticamente por sesión mediante AgentCore Runtime.
