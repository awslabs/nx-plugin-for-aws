...
- [Docker](https://www.docker.com/) (u otro motor de contenedores como [Finch](https://github.com/runfinch/finch)) es requerido para el desarrollo local de DynamoDB y para construir los componentes de AgentCore
