...
description: Un recorrido de cómo construir un juego de aventuras de mazmorra con IA agéntica usando el @aws/nx-plugin.
---
...
- packages/
  - dungeon-db/
    ...
    - dynamodb.config.json fuente de verdad para índices secundarios globales
    - src/
