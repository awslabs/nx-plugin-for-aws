...
Este es el construct CDK que define nuestro GameUI. Como puedes ver, ya está configurada la ruta al paquete generado para nuestra UI basada en Vite. Esto significa que en el momento de `build`, el empaquetado ocurre dentro del objetivo de compilación del proyecto game-ui y su salida se usa aquí.
