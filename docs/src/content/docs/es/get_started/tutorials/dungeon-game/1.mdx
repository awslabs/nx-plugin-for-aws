...
- packages/
  ...
  - game-api/ API tRPC
    ...
    - ...
- vitest.config.mts configuración de pruebas raíz que descubre las pruebas de cada proyecto
</FileTree>
...
Puede que se te presente lo siguiente:
