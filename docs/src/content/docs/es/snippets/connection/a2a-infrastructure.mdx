...
Después de ejecutar el generador de conexión, necesitas otorgar al agente host permiso para invocar el agente A2A remoto.
...
El ARN del runtime AgentCore del agente remoto se registra automáticamente en el namespace `agentcore` de <Link path="guides/runtime-config">Runtime Configuration</Link> por el constructo CDK generado, para que el agente host pueda descubrirlo en tiempo de ejecución.
</Fragment>
...
El ARN del runtime AgentCore del agente remoto se registra automáticamente en el namespace `agentcore` de <Link path="guides/runtime-config">Runtime Configuration</Link> por el módulo Terraform generado, para que el agente host pueda descubrirlo en tiempo de ejecución.
</Fragment>
</Infrastructure>
