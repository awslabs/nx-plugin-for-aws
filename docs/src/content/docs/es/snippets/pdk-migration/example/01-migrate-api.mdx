...
Luego, copiemos el archivo `handlers/typescript/src/dynamo-client.ts` del proyecto PDK a `backend/src/operations` para que esté disponible para nuestros manejadores.
