...
También puedes considerar migrar para usar el <Link path="/guides/trpc">generador `ts#trpc-api`</Link> para usar tRPC. Al momento de escribir esto, aún no tenemos soporte para suscripciones/streaming pero si esto es algo que necesitas, agrega un +1 a nuestro [issue de GitHub que rastrea esto](https://github.com/awslabs/nx-plugin-for-aws/issues/194).
