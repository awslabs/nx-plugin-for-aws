...
- [Docker](https://www.docker.com/) es necesario para algunos generadores. Usuarios de Windows: consulten la <Link path="get_started/windows-setup">guía de configuración de Windows</Link>.
