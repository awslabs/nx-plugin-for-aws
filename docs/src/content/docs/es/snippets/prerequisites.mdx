...
- [AWS Credentials](https://docs.aws.amazon.com/sdkref/latest/guide/access.html) configuradas para tu cuenta de AWS de destino (donde se desplegará tu aplicación)
...
:::tip
Si utilizas un Asistente de IA como Amazon Q Developer, Cursor, Claude Code o Cline, también puedes querer <Link path="/get_started/building-with-ai">instalar el Nx Plugin para AWS MCP server.</Link>
:::