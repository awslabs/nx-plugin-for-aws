...
Para diferentes tipos de integración por operación, necesitarías implementar integraciones explícitas manualmente (ver sección [Integraciones Explícitas](#explicit-integrations) abajo).
:::
</Fragment>
</Infrastructure>
...
No se admiten sobrescritas de autorizadores por operación con módulos de Terraform. Toda la API usa el método de autenticación especificado al generar la API (IAM, Cognito o Custom).
