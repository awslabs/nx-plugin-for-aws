...
Cuando seleccionas autenticación `Cognito`, el generador crea automáticamente la construcción `UserIdentity` y configura el agente para usar Cognito para la autenticación.
