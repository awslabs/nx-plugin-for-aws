...
Si seleccionaste `BedrockAgentCoreRuntime` para `computeType`, se genera la infraestructura CDK o Terraform relevante que puedes usar para desplegar tu Agent en [Amazon Bedrock AgentCore Runtime](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agents-tools-runtime.html).
