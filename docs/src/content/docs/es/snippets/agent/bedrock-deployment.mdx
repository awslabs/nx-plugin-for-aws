...
Es posible que desees limitar esto a los modelos específicos que usa tu agente. Los agentes Strands usan [Claude 4 Sonnet como modelo predeterminado](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/amazon-bedrock/#default-model); consulta la [guía de proveedores de modelos de Strands](https://strandsagents.com/latest/documentation/docs/user-guide/concepts/model-providers/) para configurar un modelo diferente.

<Infrastructure>
<Fragment slot="cdk">
Para limitar el alcance, edita la construcción CDK del agente generada y reemplaza los recursos predeterminados de `PolicyStatement` con los ARNs de los modelos fundacionales o perfiles de inferencia específicos que uses.
</Fragment>
<Fragment slot="terraform">
Para limitar el alcance, edita el módulo Terraform del agente generado y reemplaza los ARNs de `Resource` del modelo bedrock predeterminados con los ARNs de los modelos fundacionales o perfiles de inferencia específicos que uses.
</Fragment>
</Infrastructure>
:::
