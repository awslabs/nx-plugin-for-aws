...
Las guías de [Prompt Engineering](https://strandsagents.com/docs/user-guide/safety-security/prompt-engineering/) y [Responsible AI](https://strandsagents.com/docs/user-guide/safety-security/responsible-ai/) de Strands cubren cómo escribir prompts de sistema robustos y conscientes de la seguridad.
