...
---
- [PNPM >= 11](https://pnpm.io/installation#using-npm) (también puedes usar [Yarn >= 4](https://yarnpkg.com/getting-started/install), [Bun >= 1](https://bun.sh/docs/installation), o [NPM >= 11](https://nodejs.org/en/learn/getting-started/an-introduction-to-the-npm-package-manager) si lo prefieres)
