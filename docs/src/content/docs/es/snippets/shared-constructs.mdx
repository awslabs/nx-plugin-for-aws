...
Este proyecto se genera utilizando el generador <Link path="/es/guides/typescript-project">`ts#project`</Link> y por lo tanto configura los mismos objetivos de compilación.
:::
</Fragment>
...
:::note[Proyecto Generado]
Este proyecto se genera utilizando el generador <Link path="/es/guides/terraform-project">`terraform#project`</Link> y por lo tanto configura los mismos objetivos de compilación.
:::
</Fragment>
</Infrastructure>