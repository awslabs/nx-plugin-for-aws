...
Cuando seleccionas autenticación `Cognito`, el generador crea automáticamente el constructo `UserIdentity` y configura el servidor MCP para usar Cognito para la autenticación.
