...
El constructo `UserIdentity` puede generarse usando el <Link path="/guides/react-website-auth">generador `ts#website#auth`</Link>, o puedes crear tu propio `UserPool` y `UserPoolClient` de CDK.
</Fragment>
<Fragment slot="terraform">
