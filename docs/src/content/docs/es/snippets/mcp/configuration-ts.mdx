...
:::tip
Algunos asistentes de IA, como Kiro, permiten especificar configuraciones de servidor MCP a nivel de espacio de trabajo, lo cual es especialmente útil para definir los servidores MCP relevantes para un proyecto particular.
:::