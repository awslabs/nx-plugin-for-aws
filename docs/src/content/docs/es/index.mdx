---
title: '@aws/nx-plugin'
description: "Inicie y construya proyectos de AWS fácilmente (con plugins de NX)"
template: splash
hero:
  tagline: "Inicie y construya proyectos de AWS fácilmente (con plugins de NX)"
  image:
...
##### Comienza con ventaja usando una aplicación completamente estructurada

<CardGrid className="foo">
  <Card title="Añade componentes a tu proyecto">
    <Icon name="puzzle" size="100px"/>
  </Card>
  <Card title="Comparte código y colabora sin esfuerzo">
...
{/* TODO: Reemplazar el siguiente gif con la serie de videos instructivos */}
...
<div style={{ width: '100%' }}>
  ### Mira un ejemplo de cómo generar una interfaz
  <Image
    style={{ margin: 'auto' }}
