---
title: '@aws/nx-plugin'
description: "Cree e implemente proyectos de AWS rápidamente (con plugins de NX)"
template: splash
hero:
  tagline: "Cree e implemente proyectos de AWS rápidamente (con plugins de NX)"
  image:
...
<p class="badges">
  ...
  <a href="https://gitpod.io/new/?workspaceClass=g1-large#https://github.com/awslabs/nx-plugin-for-aws">
    <img
      ...
      alt="Listo para codificar en Gitpod"
    />
  </a>
...
##### Empieza con ventaja usando una aplicación preconfigurada
