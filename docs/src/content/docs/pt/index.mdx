---
title: '@aws/nx-plugin'
description: "Crie e construa projetos AWS facilmente (com plugins NX)"
template: splash
hero:
  tagline: "Crie e construa projetos AWS facilmente (com plugins NX)"
  image:
...
##### Obtenha uma vantagem inicial com uma aplicação totalmente pré-estruturada

<CardGrid className="foo">
  <Card title="Adicione componentes ao seu projeto">
    <Icon name="puzzle" size="100px"/>
  </Card>
  <Card title="Compartilhe código e colabore sem esforço">
...
<div style={{ width: '100%' }}>
  ### Veja um exemplo de como gerar uma interface
  <Image
    style={{ margin: 'auto' }}
    src={websiteGeneratorGif}
    alt="Um breve exemplo de como usar um gerador"
    width="800"
    height="600"
  />
</div>
