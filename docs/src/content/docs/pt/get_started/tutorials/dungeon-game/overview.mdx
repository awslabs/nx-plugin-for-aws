...
Se você usa um Assistente de IA como Kiro, Kiro CLI, Cursor, Claude Code ou Cline, consulte a página <Link path="/pt/get_started/building-with-ai">instalar o servidor MCP do Nx Plugin for AWS</Link>.
:::