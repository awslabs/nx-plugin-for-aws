...
## Tarefa 4: Integração do Agente de História

Lembre-se que no <Link path="get_started/tutorials/dungeon-game/1#task-7-connect-your-components">Módulo 1</Link>, usamos o gerador `connection` para conectar nossa Game UI ao Story Agent. Isso configurou um cliente OpenAPI tipado para interagir com o agente, juntamente com hooks e providers.
