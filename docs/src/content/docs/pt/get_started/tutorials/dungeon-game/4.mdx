...
:::tip[Usando comandos Nx]
Você pode executar comandos Nx para iniciar também quaisquer servidores de API locais conectados, permitindo que você itere tanto na API tRPC quanto no site simultaneamente. <NxCommands commands={["serve-local game-ui"]} env={{RUNTIME_CONFIG_APP_ID:"xxxx"}} />
...
:::tip[Integração de API pré-configurada]
