...
:::tip
A integração com nossa Game API já está configurada, pois usamos o gerador `api-connection`. Se desejar uma experiência similar para agentes, +1 [nesta issue do GitHub](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::
