...
Abaixo está a lista de todos os arquivos gerados pelo gerador `ts#cloudscape-website`. Vamos examinar alguns dos arquivos-chave destacados na árvore de arquivos:
<FileTree>
- packages/
  - common/
    - constructs/
...
Abaixo está a lista de todos os arquivos gerados/atualizados pelo gerador `ts#cloudscape-website#auth`. Vamos examinar alguns dos arquivos-chave destacados na árvore de arquivos:
<FileTree>
- packages/
  - common/
    - constructs/
