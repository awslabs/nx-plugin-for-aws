...
Isso configura um `AgentRuntimeArtifact` do CDK que envia sua imagem Docker do agente para o ECR e a hospeda usando o AgentCore Runtime. Ele usa `buildContexts` do CDK para referenciar a raiz do workspace, permitindo que o Dockerfile seja co-localizado com o código-fonte do agente.
