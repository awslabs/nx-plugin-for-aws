...
<Drawer title="Arquivos atualizados pelo ts#react-website" trigger="Clique aqui para examinar esses arquivos em detalhes.">
...
<Drawer title="Arquivos atualizados pelo ts#react-website#auth" trigger="Clique aqui para examinar esses arquivos em detalhes.">
