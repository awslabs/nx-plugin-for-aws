...
<RunGenerator generator="ts#api" requiredParameters={{ name: "GameApi" }} noInteractive />
...
<RunGenerator generator="ts#website" requiredParameters={{name:"GameUI", uxProvider:"Shadcn"}} noInteractive />
