...
description: "Um passo a passo de como construir um jogo de aventura em masmorras com IA agêntica usando o @aws/nx-plugin."
---
...
Com o workspace configurado, estruturamos os sub-projetos do jogo — a Game API, Story Agent, servidor MCP de Inventory, banco de dados do jogo e website — juntamente com as conexões que os conectam. Existem duas maneiras de fazer isso:
