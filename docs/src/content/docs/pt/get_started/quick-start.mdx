...
Isso configura um App CDK que você pode usar para implantar sua infraestrutura na AWS.
...
Este é todo o CDK que precisamos escrever para implantar nossa aplicação full stack.
