...
:::tip
Você precisará garantir que seu ambiente AWS foi adequadamente inicializado para o CDK.

A inicialização do CDK é necessária tanto para sua região AWS de implantação quanto para `us-east-1` para permitir a implantação do WebACL AWS WAF para o site.
