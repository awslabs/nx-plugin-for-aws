...
- .mcp.json configura o servidor MCP para agentes de codificação suportados a menos que desabilitado (também equivalentes .cursor/, .kiro/, .gemini/, .vscode/ e .codex/). Ele executa o próprio `@aws/nx-plugin` do workspace, então o servidor sempre corresponde à versão do plugin instalada
</FileTree>
