...
- .mcp.json configura o servidor MCP para agentes de codificação suportados a menos que desabilitado (também equivalentes .cursor/, .kiro/, .gemini/, .vscode/ e .codex/). Ele executa o próprio `@aws/nx-plugin-mcp` do workspace, então o servidor sempre corresponde à versão instalada em seu workspace
</FileTree>
