...
Este guia foi escrito para uma versão específica e provavelmente não será atualizado conforme o Nx Plugin for AWS evolui. Para compensar, o guia fixa a versão do `@aws/nx-plugin` em `1.0.0-rc.47`. Você pode tentar com a versão mais recente, mas podem haver diferenças em relação ao guia.
:::
