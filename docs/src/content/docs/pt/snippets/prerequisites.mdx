...
- [Docker](https://www.docker.com/) é necessário para alguns geradores. Usuários do Windows: consulte o <Link path="get_started/windows-setup">guia de Configuração do Windows</Link>.
