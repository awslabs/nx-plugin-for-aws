...
- [AWS Credentials](https://docs.aws.amazon.com/sdkref/latest/guide/access.html) configuradas para sua conta AWS de destino (onde seu aplicativo será implantado)
...
:::tip
Se você usar um Assistente de IA como Amazon Q Developer, Cursor, Claude Code ou Cline, pode querer <Link path="/get_started/building-with-ai">instalar o Nx Plugin para AWS MCP server.</Link>
:::