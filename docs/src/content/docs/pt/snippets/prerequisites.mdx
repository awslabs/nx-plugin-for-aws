...
:::tip
Se você usa um Assistente de IA como Kiro, Kiro CLI, Cursor, Claude Code ou Cline, você também pode querer <Link path="/get_started/building-with-ai">instalar o Nx Plugin para AWS MCP server.</Link>
:::