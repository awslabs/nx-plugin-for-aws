...
:::tip
Consulte também o [guia detalhado na documentação do TanStack Router](https://tanstack.com/router/latest/docs/installation/migrate-from-react-router) para cenários mais complexos.
:::
