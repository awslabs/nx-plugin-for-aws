...
Este tipo de projeto aproveitava [`create-react-app`](https://github.com/facebook/create-react-app), que agora está obsoleto. Para migrar o website neste guia, usaremos o <Link path="/guides/react-website">gerador `ts#website`</Link>, que usa tecnologias mais modernas e suportadas, nomeadamente [Vite](https://vite.dev/).
