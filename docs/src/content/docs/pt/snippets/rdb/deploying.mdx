...
O gerador de banco de dados relacional cria infraestrutura CDK ou Terraform com base no seu `iac` selecionado.
...
<Drawer title="Exemplo de configuração de VPC" trigger="Clique aqui para ver um exemplo de configuração de VPC.">
