...
A infraestrutura gerada inclui um [RDS Proxy](https://aws.amazon.com/rds/proxy/) por padrão, que fica entre sua aplicação e o cluster Aurora. O RDS Proxy oferece vários benefícios:
