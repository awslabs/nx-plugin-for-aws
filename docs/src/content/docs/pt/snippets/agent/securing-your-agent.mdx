...
Os guias de [Engenharia de Prompts](https://strandsagents.com/docs/user-guide/safety-security/prompt-engineering/) e [IA Responsável](https://strandsagents.com/docs/user-guide/safety-security/responsible-ai/) do Strands abordam como escrever prompts de sistema robustos e conscientes da segurança.
...
- Remova informações de identificação pessoal (PII) de prompts e saídas — seja com um filtro de informações sensíveis do Bedrock Guardrail (abaixo) ou, para agentes Strands, as abordagens no guia de [PII Redaction](https://strandsagents.com/docs/user-guide/safety-security/pii-redaction/).
