...
Quando você seleciona autenticação `Cognito`, o gerador cria automaticamente o construto `UserIdentity` e configura o agente para usar Cognito para autenticação.
