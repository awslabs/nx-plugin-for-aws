...
Se você selecionou `BedrockAgentCoreRuntime` para `computeType`, a infraestrutura CDK ou Terraform relevante é gerada, que você pode usar para implantar seu Agent no [Amazon Bedrock AgentCore Runtime](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agents-tools-runtime.html).
