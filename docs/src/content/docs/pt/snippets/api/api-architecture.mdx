...
As REST APIs incluem uma Web ACL do [AWS WAFv2](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html) na frente do estágio do API Gateway com o conjunto de regras padrão gerenciado pela AWS habilitado.
</TabItem>
