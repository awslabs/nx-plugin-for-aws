---
title: Configuração CORS do Terraform
---
import Link from '@components/link.astro';

:::note[Configuração CORS do Terraform]
...
- uma propriedade `cors_allow_origins`, definida como `["http://localhost:4200", "http://localhost:4300", "https://<domain name>"]`, para APIs HTTP. Isso restringe o CORS do gateway de API a esta distribuição e host local.
...
```
O construtor `MyWebsite` pode ser gerado usando o <Link path="/pt/guides/react-website">gerador `ts#website`</Link>
:::