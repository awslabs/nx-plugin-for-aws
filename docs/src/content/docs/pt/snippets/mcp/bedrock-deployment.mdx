...
Quando você seleciona autenticação `Cognito`, o gerador cria automaticamente o construto `UserIdentity` e configura o servidor MCP para usar Cognito para autenticação.
