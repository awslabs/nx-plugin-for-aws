...
O construto `UserIdentity` pode ser gerado usando o <Link path="/guides/react-website-auth">gerador `ts#website#auth`</Link>, ou você pode criar seu próprio CDK `UserPool` e `UserPoolClient`.
</Fragment>
<Fragment slot="terraform">
