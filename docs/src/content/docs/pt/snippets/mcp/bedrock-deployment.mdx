...
Passe as saídas do módulo <Link path="/guides/runtime-config#writing-configuration">`runtime_config_appconfig`</Link> compartilhado para o módulo do servidor MCP:
