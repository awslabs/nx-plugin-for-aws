...
:::tip
Alguns assistentes de IA, como o Kiro, permitem especificar uma configuração de servidor MCP no nível do workspace, o que é particularmente útil para definir os servidores MCP relevantes para um projeto específico.
:::