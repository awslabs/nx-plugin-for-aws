...
Projetos conectados podem ser executados em sua máquina com os alvos `serve` e `serve-local`. Consulte o guia <Link path="guides/local-development">Desenvolvimento Local</Link> para mais detalhes.
:::
