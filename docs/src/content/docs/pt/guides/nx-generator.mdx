...
Você pode testar padrões GritQL no [Playground GritQL](https://docs.grit.io/playground), ou instalar a CLI GritQL localmente para testar padrões contra seus arquivos:
