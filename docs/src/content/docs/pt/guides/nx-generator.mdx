...
:::warning[Modificação do Projeto]
Este gerador atualizará o `project` selecionado para usar CommonJS, pois os Nx Generators atualmente suportam apenas CommonJS ([consulte este issue do GitHub para suporte ESM](https://github.com/nrwl/nx/issues/15682)).
:::
