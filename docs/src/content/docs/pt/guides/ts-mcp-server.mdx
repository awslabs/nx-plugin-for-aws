...
Gere um servidor [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) em TypeScript para fornecer contexto a Large Language Models (LLMs), e opcionalmente implante-o no [Amazon Bedrock AgentCore](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/).
