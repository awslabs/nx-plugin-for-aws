...
<CardGrid>
  <ConnectionCard
    ...
    description="Conectar um Agente TypeScript a um servidor MCP"
  ...
  <ConnectionCard
    ...
    description="Conectar um Agente Python a um servidor MCP"
  ...
  <ConnectionCard
    ...
    description="Conectar um Servidor MCP TypeScript a uma tabela DynamoDB"
