...
<OptionFilter when={{ infra: ['agentcore', 'agentcore-ecr'] }} description="Implantação do Bedrock AgentCore Runtime">
...
Registre-o dentro de `createServer` em `server.ts` da mesma forma que uma ferramenta:
...
<OptionFilter when={{ infra: ['agentcore', 'agentcore-ecr'] }} description="Detalhes de implantação do Bedrock AgentCore Runtime">
...
<OptionFilter when={{ infra: 'agentcore' }} description="Target de pacote de código">
### Package Target
...
<OptionFilter when={{ infra: 'agentcore-ecr' }} description="Construção e varredura de imagem de contêiner">
### Docker Target
