...
O gerador `connection` conecta um <Link path="guides/ts-agent">TypeScript Strands Agent</Link> a um projeto de <Link path="guides/ts-rdb">Banco de Dados Relacional</Link>, disponibilizando um cliente Prisma dentro da sua fábrica de agente.
