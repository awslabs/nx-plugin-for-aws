...
Isso iniciará tanto o agente quanto todos os servidores MCP conectados, com o agente se conectando aos servidores MCP diretamente via HTTP em suas portas locais atribuídas.rn
  policy_arn = aws_iam_policy.agent_invoke_mcp.arn
}
```
