...
O gerador `connection` pode conectar seu <Link path="guides/py-agent">Python Strands Agent</Link> a um servidor MCP (seja <Link path="guides/ts-mcp-server">TypeScript</Link> ou <Link path="guides/py-mcp-server">Python</Link>).
...
1. Um projeto Python com um componente <Link path="guides/py-agent">Strands Agent</Link>
