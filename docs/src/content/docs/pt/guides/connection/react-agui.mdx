...
:::note
AG-UI é suportado tanto para TypeScript quanto para Python Agents. Use o gerador <Link path="guides/ts-agent">`ts#agent`</Link> ou <Link path="guides/py-agent">`py#agent`</Link> com `protocol=AG-UI`.
:::
...
- <Link path="guides/connection/react-ts-agent">Guia React para TypeScript Agent (HTTP)</Link>
- <Link path="guides/connection/react-py-agent">Guia React para Python Agent (HTTP)</Link>
- [Documentação do Protocolo AG-UI](https://docs.ag-ui.com/)
- [Pacote `@ag-ui/aws-strands`](https://www.npmjs.com/package/@ag-ui/aws-strands)
