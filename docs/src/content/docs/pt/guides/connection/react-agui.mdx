...
AG-UI ainda não é suportado para TypeScript Strands Agents. Veja [strands-agents/sdk-typescript#347](https://github.com/strands-agents/sdk-typescript/issues/347) para o status mais recente. Por enquanto, use o <Link path="guides/py-agent">gerador `py#agent`</Link> com `protocol=AG-UI`.
:::
...
2. Um Python Strands Agent com `protocol=AG-UI` (gerado usando o <Link path="guides/py-agent">gerador `py#agent`</Link>)
...
- <Link path="guides/py-agent">Guia do Python Strands Agent</Link>
- <Link path="guides/connection/react-py-agent">Guia React para Python Strands Agent (HTTP)</Link>
