...
Quando o agente se conecta diretamente ao cluster Aurora (sem RDS Proxy), o gerador de conexão atualiza o Dockerfile do agente gerado para adicionar o pacote CA do Amazon RDS em `/opt/global-bundle.pem`:
