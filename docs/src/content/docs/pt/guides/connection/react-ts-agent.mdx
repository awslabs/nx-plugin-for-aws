...
2. Um TypeScript Strands Agent (gerado usando o <Link path="guides/ts-agent">gerador `ts#agent`</Link>)
...
- <Link path="guides/ts-agent">Guia do TypeScript Strands Agent</Link>
