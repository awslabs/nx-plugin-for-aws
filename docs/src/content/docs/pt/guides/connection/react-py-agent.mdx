...
:::tip[Agentes AG-UI]
Se o seu Python Agent foi gerado com `protocol=AG-UI`, o gerador de conexão configura o [CopilotKit](https://docs.copilotkit.ai/aws-strands) e um `HttpAgent` [`@ag-ui/client`](https://docs.ag-ui.com/) no site React. Consulte o guia <Link path="guides/connection/react-agui">React to AG-UI Agent</Link> para obter detalhes.
:::
