...
Isso inicia tanto a API quanto o banco de dados local. A variável de ambiente `SERVE_LOCAL=true` é definida automaticamente, então o cliente Prisma se conecta ao banco de dados Docker local em vez do Aurora.
