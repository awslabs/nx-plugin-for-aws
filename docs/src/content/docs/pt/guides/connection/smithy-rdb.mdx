...
Isso inicia tanto a API quanto o banco de dados local. A variável de ambiente `LOCAL_DEV=true` é definida automaticamente, para que o cliente Prisma se conecte ao banco de dados Docker local em vez do Aurora.
