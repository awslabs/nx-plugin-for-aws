...
O Gateway deve usar autenticação IAM — o agente assina suas solicitações com SigV4 usando sua própria função de execução. O gerador rejeita gateways autenticados com Cognito.
