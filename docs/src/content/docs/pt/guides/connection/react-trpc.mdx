...
4. Cognito Auth adicionado via o <Link path="/guides/react-website-auth">gerador `ts#website#auth`</Link> se estiver conectando uma API que usa autenticação Cognito ou IAM
