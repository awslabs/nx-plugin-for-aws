...
:::note[Autenticação]
O navegador autentica com o **Gateway**, não com os agentes: SigV4 para um Gateway IAM (via pool de identidade Cognito do site), ou um token bearer JWT para um Gateway Cognito.
:::
