...
todos os bancos de dados conectados. A variável de ambiente `LOCAL_DEV=true` faz com que cada cliente Prisma se conecte ao seu banco de dados Docker local em vez do Aurora.
