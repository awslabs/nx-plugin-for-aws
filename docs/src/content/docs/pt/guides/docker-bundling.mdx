...
- [Documentação do `uv`](https://docs.astral.sh/uv/) — referência para exportação e instalação de dependências Python.scope-my-project:latest` já exista localmente. Execute `nx build my-project` (ou `nx docker my-project`) antes de `nx apply <project>`.
:::
</Fragment>
</Infrastructure>
