...
Agentes AG-UI podem ser conectados a um frontend React usando o <Link path="/guides/connection/react-agui">gerador de conexão `react` → agente AG-UI</Link>, que configurará componentes do [CopilotKit](https://docs.copilotkit.ai/aws-strands) para uma experiência de chat rica.
:::
...
:::tip[Conectar a um website React]
Agentes AG-UI são projetados para serem consumidos diretamente por um frontend. Use o <Link path="/guides/connection/react-agui">gerador de conexão `react` → agente AG-UI</Link> para conectar seu website React ao agente com um provedor [CopilotKit](https://docs.copilotkit.ai/aws-strands) e cliente [AG-UI HttpAgent](https://docs.ag-ui.com/).
:::
