...
Para imagens de contêiner baseadas em Debian, adicione o pacote CA do Amazon RDS ao armazenamento de confiança do sistema:
...
Para imagens de contêiner baseadas em Amazon Linux, use o comando `update-ca-trust` em vez disso:
