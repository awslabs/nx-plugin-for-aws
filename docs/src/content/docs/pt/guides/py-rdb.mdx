...
Os manipuladores de migração de banco de dados e create-db-user são executados como imagens de contêiner construídas durante o `build` do seu projeto. Essas imagens são verificadas quanto a vulnerabilidades conforme descrito abaixo.

<Snippet name="trivy-image-scan" parentHeading="Verificação de Imagens" />
