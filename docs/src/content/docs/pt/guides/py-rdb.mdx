...
`my_scope_my_db` é o nome do módulo do seu projeto de banco de dados — um único módulo plano chamado `<scope>_<name>`, visível como o diretório do pacote dentro do projeto.
