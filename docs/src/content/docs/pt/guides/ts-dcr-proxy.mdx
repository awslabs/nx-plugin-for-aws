...
O gerador cria um <Link path="/guides/typescript-project">projeto TypeScript</Link> autônomo contendo os handlers Lambda e infraestrutura para implantá-los com base no seu `iac` selecionado.
