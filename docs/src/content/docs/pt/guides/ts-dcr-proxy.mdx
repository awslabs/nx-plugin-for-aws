...
O gerador cria um <Link path="/pt/guides/typescript-project">projeto TypeScript</Link> autônomo contendo os manipuladores Lambda e infraestrutura para implantá-los com base no seu `iac` selecionado.
...
- \<dcr-proxy-name>
  ...
  - rolldown.config.ts Configuração de bundle, uma entrada por manipulador
  - README.md README do projeto
  - package.json Declara as dependências dos manipuladores
  - project.json Adiciona um target de bundle por manipulador
  - tsconfig.json / tsconfig.lib.json / tsconfig.spec.json Configuração TypeScript
