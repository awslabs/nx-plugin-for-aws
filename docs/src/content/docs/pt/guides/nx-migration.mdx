...
Para o fluxo completo da perspectiva do usuário que está atualizando — incluindo saída de exemplo para migrações determinísticas e agênticas — veja <Link path="/pt/get_started/upgrading">Atualizando Seu Workspace</Link>.
