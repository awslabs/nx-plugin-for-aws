...
:::caution
Como os targets de implantação pulam as verificações de lint, teste e verificação de tipo, a implantação não falhará em um erro de lint ou em um teste unitário com falha. Execute `build` antes de implantar qualquer coisa que você se importe, e bloqueie seu pipeline nisso:
