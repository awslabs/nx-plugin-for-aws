...
Para invocar sua API de um site React, você pode usar o <Link path="guides/connection/react-fastapi">gerador `connection`</Link>.on/react-fastapi">gerador `connection`</Link>.