...
Este comando usa `uv run uvicorn --reload` para executar seu servidor MCP com transporte HTTP (normalmente na porta `8000`), e reinicia automaticamente quando os arquivos mudam.
