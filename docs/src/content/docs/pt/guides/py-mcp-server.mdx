...
A imagem docker é construída usando uma tag (exemplo `my-scope-my-project-mcp-server:latest`), referenciada por sua infraestrutura CDK ou Terraform, permitindo que seu `Dockerfile` fique colocado junto ao projeto do servidor MCP.
:::
