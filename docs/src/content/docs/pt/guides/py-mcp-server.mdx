...
Você selecionou `None` para `computeType`, portanto nenhum construto CDK ou módulo Terraform é gerado — o servidor MCP está configurado apenas para uso local STDIO / HTTP.
</OptionFilter>
