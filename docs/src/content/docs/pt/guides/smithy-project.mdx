...
Projetos Smithy são construídos usando [Docker](https://www.docker.com/), que executa a [Smithy CLI](https://smithy.io/2.0/guides/smithy-cli/index.html) para validar seu modelo:
