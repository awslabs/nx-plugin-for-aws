...
A migração do banco de dados é executada como uma imagem de container construída durante o `build` do seu projeto. Esta imagem é verificada quanto a vulnerabilidades conforme descrito abaixo.
