...
A imagem do banco de dados local é configurada no campo `serveLocal.image` do arquivo `config.json` gerado na raiz do seu projeto de banco de dados. Atualize esse valor quando você alterar as versões do motor.
