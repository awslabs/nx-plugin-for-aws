...
:::caution[Windows]
`mise` não publica nenhum pacote Windows para npm, então instale o Smithy CLI você mesmo antes de fazer o build:
...
Veja o [guia de instalação do Smithy CLI](https://smithy.io/2.0/guides/smithy-cli/cli_installation.html) para outras opções.
:::
