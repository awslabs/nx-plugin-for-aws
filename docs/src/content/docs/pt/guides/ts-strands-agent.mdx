...
:::tip
Se você gostaria de uma experiência similar ao <Link path="/guides/api-connection">gerador de conexão de API</Link> para agentes, por favor +1 [nesta issue do GitHub](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::