...
:::tip
Para uma configuração simplificada, use o <Link path="/guides/connection/react-strands-agent">gerador Connection</Link> para conectar seu site React a um Strands Agent, que configura automaticamente o cliente tRPC WebSocket com a autenticação correta.
