...
O `package.json` do projeto começa mínimo. À medida que você adiciona dependências de runtime, elas são declaradas aqui (ferramentas compartilhadas de build/teste permanecem na raiz do workspace) — você pode descobrir mais [abaixo](#dependencies).
:::
