...
Se você selecionou `None` para `computeType`, nenhum construto CDK ou módulo Terraform é gerado — o Agent só pode ser executado localmente.
</OptionFilter>
