...
O destino de chat é executado de forma independente. Por padrão, ele se conecta ao seu agente em execução local, então inicie `<your-agent-name>-serve-local` primeiro (em um terminal separado):
