...
:::note[shadcn/ui]
您选择了 [shadcn/ui](https://ui.shadcn.com/) 作为 `uxProvider`。生成的组件和样式与 TanStack Router / Vite 并存 — 请参阅 Shadcn 文档以添加更多组件。
:::
</OptionFilter>

<OptionFilter when={{ uxProvider: 'None' }} description="No UX provider — bring your own component library">
:::note[无 UX Provider]
您为 `uxProvider` 选择了 `None`，因此没有预装组件库或设计系统。您可以自由添加您选择的组件库。
:::
</OptionFilter>
