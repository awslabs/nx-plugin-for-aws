...
聊天目标独立运行。默认情况下，它连接到本地运行的智能体，因此请先启动`<your-agent-name>-serve-local`（在单独的终端中）：
...
<CardGrid>
  <ConnectionCard
    title="React 到 Python 代理"
    description="从 React 网站调用 Python 代理"
  ...
  />
  <ConnectionCard
    title="React 到 AG-UI 代理"
    description="通过 CopilotKit 从 React 网站调用暴露 AG-UI 协议的代理"
    href={`/nx-plugin-for-aws/${Astro.currentLocale || 'en'}/guides/connection/react-agui`}
    source="react"
    target="copilotkit"
  />
  <ConnectionCard
    title="Python 代理到 MCP"
    description="将 Python 代理连接到 MCP 服务器"
  ...
  />
  <ConnectionCard
    title="Python 代理到 A2A 代理"
    description="将 Python 代理连接到远程 A2A 代理"
  ...
  />
  <ConnectionCard
    title="TypeScript 代理到 A2A 代理"
    description="将 TypeScript 代理连接到远程 A2A 代理"
  ...
  />
  <ConnectionCard
    title="Python 代理到 Python DynamoDB"
    description="将 Python 代理连接到 DynamoDB 表"
  ...
  />
  <ConnectionCard
    title="Python 代理到 AgentCore 网关"
    description="将 Python 代理连接到 AgentCore 网关"
