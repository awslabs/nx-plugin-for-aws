...
`connection` 生成器可以将您的 <Link path="guides/ts-agent">TypeScript Strands Agent</Link> 连接到远程 [A2A](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/runtime-a2a.html) 代理 — 可以是 <Link path="guides/ts-agent">TypeScript</Link> 或 <Link path="guides/py-agent">Python</Link> — 这样您的代理就可以将任务委托给另一个代理作为工具使用。
