...
:::tip[连接到React网站]
AG-UI智能体可以使用<Link path="/guides/connection/react-agui">`react` → AG-UI智能体连接生成器</Link>连接到React前端，该生成器将设置[CopilotKit](https://docs.copilotkit.ai/aws-strands)组件以提供丰富的聊天体验。
:::
...
:::tip[连接到React网站]
AG-UI智能体设计为可直接被前端使用。使用<Link path="/guides/connection/react-agui">`react` → AG-UI智能体连接生成器</Link>，通过[CopilotKit](https://docs.copilotkit.ai/aws-strands)提供器和[AG-UI HttpAgent](https://docs.ag-ui.com/)客户端将您的React网站连接到智能体。
:::
