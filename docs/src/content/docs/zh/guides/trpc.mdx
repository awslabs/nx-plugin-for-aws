...
<OptionFilter when={{ auth: 'Cognito' }} description="为 Cognito 身份验证的 CDK API 提供身份构造">
```ts {9}
...
<OptionFilter when={{ auth: 'Cognito' }} description="为 Terraform 部署的 API 提供 Cognito 配置">
要插入 Cognito 用户池和客户端,请提供相关变量:
