...
- React/Vite前端网站包含：
  ...
  - 用于UI原语和主题的[shadcn/ui](https://ui.shadcn.com/)。
  - 用于聊天体验的[CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/)，直接与智能体对话。
  - 调用游戏API的生成式SDK。
- 使用[ElectroDB](https://electrodb.dev/)/[DynamoDB](https://aws.amazon.com/dynamodb/)管理游戏状态的[tRPC](https://trpc.io/) API。
- 通过AG-UI协议公开并托管在[Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/)上的[Strands](https://strandsagents.com/)智能体。聊天历史记录由AgentCore Runtime按会话自动持久化。
