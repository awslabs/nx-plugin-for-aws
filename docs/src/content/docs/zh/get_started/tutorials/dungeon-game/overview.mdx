...
- [AWS Credentials](https://docs.aws.amazon.com/sdkref/latest/guide/access.html) 配置到您的目标AWS账户，因为本教程会部署应用程序并调用Amazon Bedrock
- [Docker](https://www.docker.com/)（或[Finch](https://github.com/runfinch/finch)）是本地DynamoDB开发和构建AgentCore组件所必需的
