...
- [Docker](https://www.docker.com/)（或 [Finch](https://github.com/runfinch/finch)）是本地 DynamoDB 开发和构建 AgentCore 组件所必需的

:::tip[AI 助手设置]
如果您使用 AI 助手，例如 Kiro、Kiro CLI、Cursor、Claude Code 或 Cline，请参阅<Link path="/zh/get_started/building-with-ai">安装 Nx Plugin for AWS MCP 服务器</Link>页面。
:::