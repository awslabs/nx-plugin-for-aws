...
:::tip
您也可以运行 Nx 命令来启动所有关联的 API 本地服务器，方便您同时迭代 tRPC API 和网站。<NxCommands commands={["run @dungeon-adventure/game-ui:serve-local"]} env={{TABLE_NAME:"dungeon-adventure-infra-sandbox-Application-ElectroDbTableXXX-YYY"}} />
:::
