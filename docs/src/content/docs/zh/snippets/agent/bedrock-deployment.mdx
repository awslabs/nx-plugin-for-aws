...
如果您为 `infra` 选择了 `agentcore`，将生成相关的 CDK 或 Terraform 基础设施，您可以使用它将 Agent 部署到 [Amazon Bedrock AgentCore Runtime](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agents-tools-runtime.html)。
