...
Strands 的[提示工程](https://strandsagents.com/docs/user-guide/safety-security/prompt-engineering/)和[负责任的 AI](https://strandsagents.com/docs/user-guide/safety-security/responsible-ai/)指南介绍了如何编写健壮且注重安全的系统提示。
