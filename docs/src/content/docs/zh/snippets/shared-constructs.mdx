...
此项目使用 <Link path="/zh/guides/typescript-project">`ts#project`</Link> 生成器生成，因此配置了相同的构建目标。
:::
</Fragment>
...
:::note[Generated Project]
此项目使用 <Link path="/zh/guides/terraform-project">`terraform#project`</Link> 生成器生成，因此配置了相同的构建目标。
:::
</Fragment>
</Infrastructure>