...
有关更多详细信息，请参阅 [Amazon RDS SSL/TLS 文档](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.html)。使用 RDS Proxy 时，您无需配置 `NODE_EXTRA_CA_CERTS`。
