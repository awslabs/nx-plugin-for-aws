...
- [Docker](https://www.docker.com/) là bắt buộc đối với một số trình tạo. Người dùng Windows: xem <Link path="get_started/windows-setup">hướng dẫn Cài đặt Windows</Link>.
