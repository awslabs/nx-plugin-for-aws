...
:::tip
Nếu bạn sử dụng AI Assistant như Kiro, Kiro CLI, Cursor, Claude Code hoặc Cline, bạn cũng có thể muốn <Link path="/get_started/building-with-ai">cài đặt Nx Plugin cho AWS MCP server.</Link>
:::