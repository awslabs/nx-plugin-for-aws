...
Các hướng dẫn [Prompt Engineering](https://strandsagents.com/docs/user-guide/safety-security/prompt-engineering/) và [Responsible AI](https://strandsagents.com/docs/user-guide/safety-security/responsible-ai/) của Strands bao gồm việc viết các system prompt mạnh mẽ, có ý thức về an toàn.
...
- Biên tập thông tin nhận dạng cá nhân (PII) khỏi các prompt và đầu ra — bằng bộ lọc thông tin nhạy cảm của Bedrock Guardrail (bên dưới) hoặc, đối với các agent Strands, các cách tiếp cận trong hướng dẫn [PII Redaction](https://strandsagents.com/docs/user-guide/safety-security/pii-redaction/).
