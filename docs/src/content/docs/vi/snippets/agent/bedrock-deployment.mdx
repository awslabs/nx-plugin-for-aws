...
Construct `UserIdentity` có thể được tạo bằng <Link path="/guides/react-website-auth">trình tạo `ts#website#auth`</Link>, hoặc bạn có thể tạo `UserPool` và `UserPoolClient` CDK của riêng mình.
</Fragment>
<Fragment slot="terraform">
