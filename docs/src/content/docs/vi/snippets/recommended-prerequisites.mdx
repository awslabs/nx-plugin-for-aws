...
---
- [PNPM >= 11](https://pnpm.io/installation#using-npm) (bạn cũng có thể sử dụng [Yarn >= 4](https://yarnpkg.com/getting-started/install), [Bun >= 1](https://bun.sh/docs/installation), hoặc [NPM >= 11](https://nodejs.org/en/learn/getting-started/an-introduction-to-the-npm-package-manager) nếu bạn muốn)
