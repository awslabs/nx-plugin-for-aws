...
:::tip
Một lợi thế lớn của Nx Plugin for AWS so với PDK là các construct CDK mà nó cung cấp là mã nguồn được thêm vào dự án của bạn thay vì được import qua một package bên thứ ba. Điều này cho bạn quyền kiểm soát và tính linh hoạt để tùy chỉnh chúng vượt xa những gì PDK hỗ trợ.
:::
...
1. Cấp quyền cho các hàm lambda truy cập bảng DynamoDB.
