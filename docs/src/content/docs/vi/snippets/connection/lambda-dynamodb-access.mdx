---
title: Truy cập DynamoDB từ Lambda
---
...
Gọi `grantReadWriteData` trên construct của bảng. Điều này cấp cả quyền DynamoDB và KMS cần thiết cho vai trò thực thi Lambda:
...
Cấp quyền cho vai trò thực thi Lambda để truy cập bảng DynamoDB và khóa mã hóa KMS của nó:
