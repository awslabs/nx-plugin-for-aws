...
ARN runtime AgentCore của agent từ xa được tự động đăng ký trong namespace `agentcore` của <Link path="guides/runtime-config">Runtime Configuration</Link> bởi CDK construct được tạo, do đó agent chủ có thể khám phá nó tại runtime.
</Fragment>
...
ARN runtime AgentCore của agent từ xa được tự động đăng ký trong namespace `agentcore` của <Link path="guides/runtime-config">Runtime Configuration</Link> bởi module Terraform được tạo, do đó agent chủ có thể khám phá nó tại runtime.
</Fragment>
</Infrastructure>