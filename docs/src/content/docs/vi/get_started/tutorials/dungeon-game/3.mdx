...
<Tabs>
  ...
  <TabItem label="Deployed">
    ...
    :::caution
    Sử dụng output `UserIdentityUserIdentityUserPoolIdXXX` cho `POOL_ID` và đảm bảo bạn có Client ID tương ứng từ các output triển khai CDK của bạn.
    :::
