...
- [Docker](https://www.docker.com/) (hoặc [Finch](https://github.com/runfinch/finch)) là bắt buộc để phát triển DynamoDB cục bộ và để xây dựng các thành phần AgentCore
