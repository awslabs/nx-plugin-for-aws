...
- [Docker](https://www.docker.com/) (hoặc một container engine khác như [Finch](https://github.com/runfinch/finch)) là bắt buộc để phát triển DynamoDB cục bộ và để xây dựng các thành phần AgentCore
