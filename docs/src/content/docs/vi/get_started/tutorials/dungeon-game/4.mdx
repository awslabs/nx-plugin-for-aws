...
:::tip
Bạn có thể chạy các lệnh Nx thay thế để khởi động bất kỳ máy chủ API cục bộ nào được kết nối, cho phép bạn lặp lại cả tRPC API và trang web của bạn cùng nhau. <NxCommands commands={["run @dungeon-adventure/game-ui:serve-local"]} env={{TABLE_NAME:"dungeon-adventure-infra-sandbox-Application-ElectroDbTableXXX-YYY"}} />
:::
