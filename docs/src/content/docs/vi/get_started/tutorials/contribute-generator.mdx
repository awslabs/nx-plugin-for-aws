...
- `packages/nx-plugin/src/internal/test-matrix/generator.ts` — một generator ẩn kết hợp tất cả các generators khác để kiểm thử việc migration giữa các phiên bản.
