...
Để gọi API của bạn từ một React website, bạn có thể sử dụng <Link path="guides/connection/react-fastapi">`connection` generator</Link>./react-fastapi">`connection` generator</Link>.