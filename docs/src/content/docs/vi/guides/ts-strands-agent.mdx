...
:::tip
Để có thiết lập đơn giản hơn, sử dụng <Link path="/guides/connection/react-strands-agent">Connection generator</Link> để kết nối website React của bạn với Strands Agent, generator này tự động thiết lập tRPC WebSocket client với xác thực đúng.
