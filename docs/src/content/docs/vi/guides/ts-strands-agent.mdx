...
:::tip
Nếu bạn muốn có trải nghiệm tương tự như <Link path="/guides/api-connection">generator API connection</Link> cho các agent, vui lòng +1 [GitHub issue này](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::