...
CLI sử dụng client phù hợp với giao thức (`AgentClient.local` cho HTTP/tRPC hoặc `@a2a-js/sdk` cho A2A) và stream các response của agent từng token một thông qua [`@clack/prompts`](https://github.com/bombshell-dev/clack).
