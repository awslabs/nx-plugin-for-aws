...
:::note[Hệ thống thiết kế Cloudscape]
...
:::note[shadcn/ui]
Bạn đã chọn [shadcn/ui](https://ui.shadcn.com/) làm `uxProvider`. Các component và style được tạo ra nằm cùng với TanStack Router / Vite — tham khảo tài liệu Shadcn để thêm các component khác.
:::
</OptionFilter>

<OptionFilter when={{ uxProvider: 'None' }} description="No UX provider — bring your own component library">
:::note[Không có UX Provider]
Bạn đã chọn `None` cho `uxProvider`, vì vậy không có thư viện component hoặc hệ thống thiết kế nào được tích hợp. Bạn có thể tự do thêm thư viện component mà bạn chọn.
:::
</OptionFilter>
