...
export class ApplicationStack extends Stack {
  constructor(scope: Construct, id: string) {
    ...
    // Website có thể được khai báo tại bất kỳ điểm nào — runtime config được giải quyết một cách lazy
...
:::note
Với CDK, construct website có thể được khai báo tại bất kỳ điểm nào trong stack của bạn. Cấu hình runtime được giải quyết một cách lazy tại thời điểm synth, vì vậy tất cả các giá trị sẽ được bao gồm bất kể thứ tự khai báo.
:::
</Fragment>
<Fragment slot="terraform">
