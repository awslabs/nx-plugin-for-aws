...
Khi [vấn đề này với MCP SDK](https://github.com/modelcontextprotocol/typescript-sdk/issues/164) được giải quyết, bạn có thể xóa phụ thuộc `zod-v3` bổ sung và chỉ cần import từ `zod`.
:::
