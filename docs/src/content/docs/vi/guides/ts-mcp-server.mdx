...
<CardGrid>
  <ConnectionCard
    ...
    description="Kết nối một TypeScript Agent với máy chủ MCP"
  ...
  <ConnectionCard
    ...
    description="Kết nối một Python Agent với máy chủ MCP"
  ...
  <ConnectionCard
    ...
    description="Kết nối một TypeScript MCP Server với cơ sở dữ liệu quan hệ Aurora"
  ...
  <ConnectionCard
    ...
    description="Kết nối một TypeScript MCP Server với bảng DynamoDB"
    href={`/nx-plugin-for-aws/${Astro.currentLocale || 'vi'}/guides/connection/ts-mcp-server-dynamodb`}
    source="mcp"
    target="dynamodb"
  />
  <ConnectionCard
    title="AgentCore Gateway to MCP Server"
    description="Tổng hợp một máy chủ MCP phía sau AgentCore Gateway"
