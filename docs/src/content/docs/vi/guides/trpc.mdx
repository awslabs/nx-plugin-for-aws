...
Nếu bạn đang gọi API của bạn từ một website React, hãy xem xét sử dụng trình tạo <Link path="guides/connection/react-trpc">API Connection</Link> để cấu hình client.
