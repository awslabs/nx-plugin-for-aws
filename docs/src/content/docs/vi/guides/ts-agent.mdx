...
Target chat chạy độc lập. Mặc định nó kết nối với agent đang chạy locally của bạn, vì vậy hãy khởi động `<your-agent-name>-serve-local` trước (trong một terminal riêng):
...
<CardGrid>
  <ConnectionCard
    ...
    description="Gọi TypeScript Agent từ một React website"
  ...
  <ConnectionCard
    ...
    description="Gọi Agent expose giao thức AG-UI từ một React website thông qua CopilotKit"
  ...
  <ConnectionCard
    ...
    description="Kết nối TypeScript Agent với một MCP server"
  ...
  <ConnectionCard
    ...
    description="Kết nối TypeScript Agent với một remote A2A agent"
  ...
  <ConnectionCard
    ...
    description="Kết nối Python Agent với một remote A2A agent"
  ...
  <ConnectionCard
    ...
    description="Kết nối TypeScript Agent với một Aurora relational database"
  ...
  <ConnectionCard
    ...
    description="Kết nối TypeScript Agent với một DynamoDB table"
  ...
  <ConnectionCard
    ...
    description="Kết nối TypeScript Agent với một AgentCore Gateway"
