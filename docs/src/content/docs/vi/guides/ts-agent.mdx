...
Nếu bạn chọn `None` cho `computeType`, không có CDK construct hoặc Terraform module nào được tạo ra — Agent chỉ có thể chạy locally.
</OptionFilter>
