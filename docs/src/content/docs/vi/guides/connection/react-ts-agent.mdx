...
2. Một TypeScript Strands Agent (được tạo bằng <Link path="guides/ts-agent">`ts#agent` generator</Link>)
...
- <Link path="guides/ts-agent">Hướng Dẫn TypeScript Strands Agent</Link>
