...
Trình tạo `connection` có thể kết nối <Link path="guides/py-agent">Python Strands Agent</Link> của bạn với một MCP server (có thể là <Link path="guides/ts-mcp-server">TypeScript</Link> hoặc <Link path="guides/py-mcp-server">Python</Link>).
...
1. Một dự án Python với component <Link path="guides/py-agent">Strands Agent</Link>
