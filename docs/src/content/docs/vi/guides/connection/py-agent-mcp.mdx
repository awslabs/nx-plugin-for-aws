...
Client Strands là một context manager, được nhập vào trong một khối `with` xung quanh agent. Tham số `session_id` được truyền từ người gọi, đảm bảo tính nhất quán cho [Bedrock AgentCore Observability](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/observability.html).
</TabItem>
