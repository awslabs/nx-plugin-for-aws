...
Generator `connection` kết nối một <Link path="guides/ts-agent">TypeScript Strands Agent</Link> với dự án <Link path="guides/ts-rdb">Relational Database</Link>, làm cho Prisma client có sẵn bên trong agent factory của bạn.
