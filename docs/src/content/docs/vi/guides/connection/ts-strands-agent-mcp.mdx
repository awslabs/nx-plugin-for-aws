...
ARN runtime AgentCore của máy chủ MCP được tự động đăng ký trong namespace `connection` của <Link path="guides/runtime-config">Runtime Configuration</Link> bởi CDK construct được tạo, để agent có thể khám phá nó khi chạy.
</Fragment>
...
ARN runtime AgentCore của máy chủ MCP được tự động đăng ký trong namespace `connection` của <Link path="guides/runtime-config">Runtime Configuration</Link> bởi module Terraform được tạo, để agent có thể khám phá nó khi chạy.
</Fragment>
</Infrastructure>
