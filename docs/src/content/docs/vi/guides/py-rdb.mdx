...
`my_scope_my_db` là tên module của dự án cơ sở dữ liệu của bạn — một module phẳng duy nhất có tên `<scope>_<name>`, hiển thị dưới dạng thư mục package bên trong dự án.
