...
Các handler migration cơ sở dữ liệu và create-db-user chạy dưới dạng container images được xây dựng trong quá trình `build` của dự án. Các image này được quét để tìm lỗ hổng bảo mật như mô tả bên dưới.
