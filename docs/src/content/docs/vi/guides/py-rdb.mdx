...
Đối với các container image dựa trên Debian, thêm Amazon RDS CA bundle vào system trust store:
...
Đối với các container image dựa trên Amazon Linux, sử dụng lệnh `update-ca-trust` thay thế:
