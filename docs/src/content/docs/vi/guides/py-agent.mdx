...
<CardGrid>
  <ConnectionCard
    ...
    description="Gọi Python Agent từ một React website"
  ...
  <ConnectionCard
    ...
    description="Gọi một Agent expose giao thức AG-UI từ một React website thông qua CopilotKit"
  ...
  <ConnectionCard
    ...
    description="Kết nối TypeScript Agent với một A2A agent từ xa"
  ...
  <ConnectionCard
    ...
    description="Kết nối Python Agent với một bảng DynamoDB"
