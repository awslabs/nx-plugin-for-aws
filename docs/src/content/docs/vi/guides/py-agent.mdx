...
Để có hướng dẫn chuyên sâu hơn về viết Strands agent, hãy tham khảo [tài liệu Strands](https://strandsagents.com/docs/user-guide/quickstart/overview/). Đối với các LangChain agent, [`connection` generator](/guides/connection/py-agent-mcp) cũng kết nối các công cụ từ MCP server và A2A agent vào `create_agent`.
