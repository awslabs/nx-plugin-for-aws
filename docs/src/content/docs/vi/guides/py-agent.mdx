...
Để gọi Strands Agent của bạn từ một React website, bạn có thể sử dụng <Link path="/guides/connection/react-py-agent">`connection` generator</Link>, tự động thiết lập một client với xác thực chính xác (IAM hoặc Cognito).
