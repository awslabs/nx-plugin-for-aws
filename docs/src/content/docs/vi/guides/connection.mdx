...
:::tip[Vẽ trực quan]
Bạn muốn thiết kế workspace trước? <Link path="get_started/graph-builder">Graph Builder</Link> cho phép bạn kéo thả các dự án và vẽ các kết nối giữa chúng, sau đó cung cấp cho bạn các lệnh để tạo tất cả.
:::
...
<CardGrid>
  ...
  <ConnectionCard
    ...
    description="Kết nối FastAPI với cơ sở dữ liệu quan hệ Aurora của Python"
  ...
  <ConnectionCard
    ...
    description="Kết nối Python Agent với cơ sở dữ liệu quan hệ Aurora của Python"
  ...
  <ConnectionCard
    ...
    description="Kết nối Python MCP Server với cơ sở dữ liệu quan hệ Aurora của Python"
  ...
  <ConnectionCard
    ...
    description="Đặt agent phía trước với AgentCore Gateway làm runtime target"
...
Các dự án được kết nối có thể được chạy trên máy của bạn với các target `serve` và `dev`. Xem hướng dẫn <Link path="guides/local-development">Local Development</Link> để biết chi tiết.
:::
