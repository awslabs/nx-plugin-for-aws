...
Để gọi API của bạn từ một React website, bạn có thể sử dụng trình tạo <Link path="guides/connection/react-smithy">`connection`</Link>, cung cấp tạo client an toàn kiểu từ mô hình Smithy của bạn.àn kiểu từ mô hình Smithy của bạn.