...
CLI được giải quyết bởi [mise](https://mise.jdx.dev/), mà quá trình build tải về theo yêu cầu, vì vậy không có gì cần cài đặt — nó tải xuống và lưu vào bộ nhớ cache phiên bản đã được ghim lần đầu tiên bạn build.
