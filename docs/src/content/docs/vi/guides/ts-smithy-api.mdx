...
:::caution[Windows]
`mise` không xuất bản gói Windows lên npm, vì vậy hãy tự cài đặt Smithy CLI trước khi build:
...
Xem [hướng dẫn cài đặt Smithy CLI](https://smithy.io/2.0/guides/smithy-cli/cli_installation.html) để biết các tùy chọn khác.
:::
