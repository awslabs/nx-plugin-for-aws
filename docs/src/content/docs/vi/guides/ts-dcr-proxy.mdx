...
Trình tạo tạo ra một <Link path="/guides/typescript-project">dự án TypeScript</Link> độc lập chứa các Lambda handler, và cơ sở hạ tầng để triển khai chúng dựa trên `iac` bạn đã chọn.
