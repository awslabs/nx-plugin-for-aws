...
Lệnh này sử dụng `uv run uvicorn --reload` để chạy MCP server của bạn với HTTP transport (thường trên cổng `8000`), và tự động khởi động lại khi các tệp thay đổi.
