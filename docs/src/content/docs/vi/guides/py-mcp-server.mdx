...
Bạn đã chọn `None` cho `computeType`, vì vậy không có CDK construct hoặc Terraform module nào được tạo — máy chủ MCP được cấu hình chỉ để sử dụng STDIO / HTTP cục bộ.
</OptionFilter>
