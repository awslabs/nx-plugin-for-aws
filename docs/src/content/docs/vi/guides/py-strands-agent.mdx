...
Các AG-UI agent có thể được kết nối với React frontend bằng cách sử dụng <Link path="/guides/connection/react-agui">`react` → AG-UI agent connection generator</Link>, sẽ thiết lập các component [CopilotKit](https://docs.copilotkit.ai/aws-strands) cho trải nghiệm chat phong phú.
:::
...
:::tip[Kết nối với React website]
Các AG-UI agent được thiết kế để được sử dụng trực tiếp bởi frontend. Sử dụng <Link path="/guides/connection/react-agui">`react` → AG-UI agent connection generator</Link> để kết nối React website của bạn với agent thông qua provider [CopilotKit](https://docs.copilotkit.ai/aws-strands) và client [AG-UI HttpAgent](https://docs.ag-ui.com/).
:::
