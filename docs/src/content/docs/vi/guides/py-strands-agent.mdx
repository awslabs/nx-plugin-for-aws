...
:::note
Lưu ý rằng vì FastAPI hiện không hỗ trợ tạo OpenAPI specification cho streaming responses, chúng ta phải thiết lập rõ ràng response model cho mỗi streaming operation, ví dụ:
...
Có một [yêu cầu tính năng mở để hỗ trợ native trong FastAPI](https://github.com/fastapi/fastapi/discussions/14362).
