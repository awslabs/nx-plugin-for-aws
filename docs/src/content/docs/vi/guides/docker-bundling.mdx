...
Quá trình quét được cố ý không kết nối vào `build` vì điều này có thể gây ra ma sát không cần thiết khi lặp lại trong quá trình phát triển, do cơ sở dữ liệu lỗ hổng của Trivy được cập nhật liên tục với các CVE mới.

Thay vào đó, chúng tôi khuyến nghị chạy lệnh trên như một bước riêng biệt trong CI pipeline của bạn trước khi triển khai lên các giai đoạn production.
:::
