---
title: '@aws/nx-plugin'
description: "Khởi tạo nhanh chóng và xây dựng các dự án AWS một cách dễ dàng (với các plugin NX)"
template: splash
hero:
  tagline: "Khởi tạo nhanh chóng và xây dựng các dự án AWS một cách dễ dàng (với các plugin NX)"
  image:
