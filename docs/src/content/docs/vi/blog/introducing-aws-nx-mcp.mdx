---
title: Giới thiệu Nx Plugin for AWS MCP Server
description: Xây dựng khung sườn với tính xác định để tăng tốc vibe-coding
date: 2025-05-26
authors:
  - jack
---
...
Để biết hướng dẫn chi tiết, hãy tham khảo <Link path="/vi/get_started/building-with-ai">hướng dẫn Xây dựng với AI</Link> của chúng tôi.