...
Nếu bạn quan tâm đến việc khám phá phát triển AWS có sự hỗ trợ của AI với nhiều cấu trúc và độ tin cậy hơn, hãy thử Nx Plugin for AWS MCP Server. Bạn có thể thiết lập nó trong AI Assistant yêu thích của mình (Kiro, Kiro CLI, Cline, Claude Code, v.v.) với cấu hình MCP Server sau:
