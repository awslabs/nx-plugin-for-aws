...
Hướng dẫn này sẽ đưa bạn qua một ví dụ di chuyển dự án [AWS PDK](https://github.com/aws/aws-pdk) sang Nx Plugin for AWS, cũng như cung cấp hướng dẫn chung về chủ đề này.

Di chuyển sang Nx Plugin for AWS mang lại các lợi ích sau so với PDK:

- Build nhanh hơn
- Dễ sử dụng hơn (UI và CLI)
- Thân thiện với vibe-coding (<Link path="/vi/get_started/building-with-ai">thử MCP server của chúng tôi!</Link>)
...
Có nhiều sắc thái và cân nhắc khi di chuyển một dự án. Hướng dẫn này dành cho một ví dụ đơn giản, và có thể có các bước còn thiếu ở đây mà dự án của bạn yêu cầu.

Hướng dẫn này chọn cách tiếp cận tạo một workspace mới và sao chép các phần từ dự án PDK của chúng ta vào dự án mới. Nếu bạn cần di chuyển theo cách khác, hoặc có bất kỳ câu hỏi nào về việc chuyển từ PDK sang Nx Plugin for AWS, [hãy liên hệ trên GitHub discussions](https://github.com/awslabs/nx-plugin-for-aws/discussions)!

Cũng lưu ý rằng một số tính năng của PDK không có tương đương chính xác. Tham khảo phần [FAQ](#frequently-asked-questions) để biết một số gợi ý/ý tưởng cho những tính năng này.
:::
...
Trong hướng dẫn này, chúng ta sẽ sử dụng [Ứng dụng Danh sách Mua sắm từ PDK Tutorial](https://aws.github.io/aws-pdk/getting_started/shopping_list_app.html) làm dự án mục tiêu để di chuyển. Làm theo các bước trong hướng dẫn đó để tạo dự án mục tiêu nếu bạn muốn tự làm theo.
