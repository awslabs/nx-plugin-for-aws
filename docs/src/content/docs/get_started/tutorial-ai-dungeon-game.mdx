...
<SheetWrapper client:load title="ts#trpc-api updated files" trigger="Click here to examine these files in more detail.">
...
<RunGenerator generator="py#fast-api" requiredParameters={{name:"StoryApi"}} />

You should see some new files have appeared in your file tree.
<SheetWrapper client:load title="py#fast-api updated files" trigger="Click here to examine these files in more detail.">
...
<RunGenerator generator="ts#cloudscape-website" requiredParameters={{name:"GameUI"}} />

You should see some new files have appeared in your file tree.

<SheetWrapper client:load title="ts#cloudscape-website updated files" trigger="Click here to examine these files in more detail.">
...
<RunGenerator generator="ts#cloudscape-website#auth" requiredParameters={{cognitoDomain:"game-ui", project:"@dungeon-adventure/game-ui", allowSignup:true}} />

You should see some new files have appeared/changed in your file tree.

<SheetWrapper client:load title="ts#cloudscape-website#auth updated files" trigger="Click here to examine these files in more detail.">
...
<RunGenerator generator="api-connection" requiredParameters={{sourceProject:"@dungeon-adventure/game-ui", targetProject:"dungeon_adventure.story_api"}} />

You should see some new files have appeared/changed in your file tree.

<SheetWrapper client:load title="UI -> FastAPI api-connection updated files" trigger="Click here to examine these files in more detail.">
...
<RunGenerator generator="api-connection" requiredParameters={{sourceProject:"@dungeon-adventure/game-ui", targetProject:"@dungeon-adventure/game-api-backend"}} />

You should see some new files have appeared/changed in your file tree.

<SheetWrapper client:load title="UI -> tRPC api-connection updated files" trigger="Click here to examine these files in more detail.">
Below is a list of all files which have been generated/updated by the `api-connection` generator. We are going to examine some of the key files highlighted in the file tree:
<FileTree>
- packages/
  - game-ui/
...
<SheetWrapper client:load title="ts#infra updated files" trigger="Click here to examine these files in more detail.">
...
Let's make an update to our `application-stack.ts` to instantiate some of our already generated constructs:
...
Now it's time for us to build our code for the first time. To do this, run the following command:
...
<Aside type="tip">
If you encounter any lint errors, you can run the following command to auto fix them.

```pnpm nx run-many --target lint --configuration=fix --all --output-style=stream```
</Aside>
