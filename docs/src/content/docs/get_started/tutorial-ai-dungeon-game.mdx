...
<p>
<span>Now it's time for us to </span>
<SheetWrapper client:load title="Nx commands" trigger="build our code">
...
You can also visualize your dependencies via: <NxCommands commands={['graph']} />
<br/>
