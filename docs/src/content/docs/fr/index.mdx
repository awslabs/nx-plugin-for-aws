---
title: '@aws/nx-plugin'
description: "Démarrez et construisez facilement des projets AWS (avec des plugins NX)"
template: splash
hero:
  tagline: "Démarrez et construisez facilement des projets AWS (avec des plugins NX)"
  image:
...
##### Démarrez rapidement avec une application préstructurée complète

<CardGrid className="foo">
  <Card title="Ajoutez des composants à votre projet">
    <Icon name="puzzle" size="100px"/>
  </Card>
  <Card title="Partagez du code et collaborez facilement">
...
{/* TODO: Remplacer le gif ci-dessous par la série vidéo */}
{/* ##### Série vidéo d'apprentissage */}
{/* <a href="/videos/course/overview"> */}
{/* <VideoPlayer link="https://www.youtube.com/watch?v=5u0Ds7wzUeI" /> */}
{/* </a> */}

<div style={{ width: '100%' }}>
  ### Exemple de génération d'une interface utilisateur
  <Image
    style={{ margin: 'auto' }}
