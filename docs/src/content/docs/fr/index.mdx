...
<p class="badges">
  ...
  <a href="https://gitpod.io/new/?workspaceClass=g1-large#https://github.com/awslabs/nx-plugin-for-aws">
    <img
      src="https://img.shields.io/badge/Gitpod-prêt%20à%20coder-blue?logo=gitpod"
...
##### Obtenez une longueur d'avance avec une application entièrement structurée
...
<CardGrid className="foo">
  ...
  <Card title="Personnalisez vos projets à votre façon">
...
{/* ##### Regardez et apprenez avec notre série */}
