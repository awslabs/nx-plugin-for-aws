...
##### Démarrez rapidement avec une application pré-structurée complète

<CardGrid className="foo">
  <Card title="Ajoutez des composants à votre projet">
    <Icon name="puzzle" size="100px"/>
  </Card>
  <Card title="Partagez du code et collaborez sans heurts">
    <Icon name="seti:bicep" size="100px"/>
  </Card>
  <Card title="Personnalisez vos projets à votre manière">
...
{/* TODO: Remplacer le gif ci-dessous par la série watch and learn */}
{/* ##### Regardez notre série didactique */}
