...
:::note
Consultez le <Link path="guides/workspace">Guide de l'espace de travail</Link> pour tous les détails sur les options, la structure et les commandes courantes de l'espace de travail.
:::
