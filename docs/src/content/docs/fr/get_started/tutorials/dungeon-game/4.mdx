...
:::tip
Vous pouvez exécuter des commandes Nx à la place pour démarrer les serveurs API locaux connectés, vous permettant d'itérer simultanément sur votre API tRPC et votre site web. <NxCommands commands={["run @dungeon-adventure/game-ui:serve-local"]} env={{RUNTIME_CONFIG_APP_ID:"xxxx"}} />
