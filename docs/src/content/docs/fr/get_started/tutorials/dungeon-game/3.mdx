...
Pour cela, nous allons d'abord mettre à jour nos constructions CDK comme suit :
...
```
    <Aside type="caution">
    Utilisez la valeur de sortie CDK `dungeon-adventure-infra-sandbox-Application.StoryApiStoryApiUrlXXX` pour remplacer l'URL et ajustez la région.
    </Aside>
  </TabItem>
</Tabs>
