...
Nous utilisons `--iac=cdk` car nous utiliserons CDK pour l'infrastructure as code dans ce tutoriel. Le Nx Plugin pour AWS supporte également `terraform`.
:::
...
<Drawer title="Fichiers modifiés par ts#api" trigger="Cliquez ici pour examiner ces fichiers en détail.">
