...
description: "Un guide pas à pas pour créer un jeu d'aventure de donjon alimenté par une IA agentique en utilisant le @aws/nx-plugin."
---
...
Avec l'espace de travail en place, nous échafaudons les sous-projets du jeu — l'API Game, l'agent Story, le serveur MCP Inventory, la base de données du jeu et le site web — ainsi que les connexions qui les relient. Il y a deux façons de procéder :
