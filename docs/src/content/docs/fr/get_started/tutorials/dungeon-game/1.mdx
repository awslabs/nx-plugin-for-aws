...
Avec l'espace de travail en place, nous échafaudons les sous-projets du jeu — l'API de jeu, l'agent Story, le serveur MCP d'inventaire, la base de données du jeu et le site web — ainsi que les connexions qui les relient. Il y a deux façons de procéder :
