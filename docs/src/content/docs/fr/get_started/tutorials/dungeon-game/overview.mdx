...
- Un frontend React/Vite utilisant :
  ...
  - [shadcn/ui](https://ui.shadcn.com/) pour les primitives d'interface utilisateur et les thèmes.
  - [CopilotKit](https://copilotkit.ai/) + [AG-UI](https://ag-ui.com/) pour l'expérience de chat, permettant de parler directement à l'agent.
...
- Un Agent [Strands](https://strandsagents.com/) exposé via le protocole AG-UI et hébergé sur [Amazon Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/). L'historique des conversations est automatiquement persisté par session par AgentCore Runtime.
