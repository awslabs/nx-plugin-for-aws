...
- [Docker](https://www.docker.com/) (ou un autre moteur de conteneurs tel que [Finch](https://github.com/runfinch/finch)) est requis pour le développement local de DynamoDB et pour construire les composants AgentCore
