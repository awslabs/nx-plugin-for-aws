...
Si vous avez terminé le <Link path="get_started/tutorials/dungeon_game/overview">tutoriel de l'aventure donjon</Link>, ou si vous avez déjà un autre espace de travail Nx utilisant une API tRPC, vous pouvez sauter cette étape.
:::
