...
Vous pouvez essayer des patterns GritQL dans le [GritQL Playground](https://docs.grit.io/playground), ou installer le CLI GritQL pour tester les patterns localement :
