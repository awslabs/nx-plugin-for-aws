...
Avec `infra: None`, aucune infrastructure AWS n'est générée. L'agent s'exécute en tant que processus local et appelle Amazon Bedrock pour l'inférence de modèle.
