---
title: "Conditions préalables requises"
---
...
- [Identifiants AWS](https://docs.aws.amazon.com/sdkref/latest/guide/access.html) configurées pour votre compte AWS cible (où votre application sera déployée)