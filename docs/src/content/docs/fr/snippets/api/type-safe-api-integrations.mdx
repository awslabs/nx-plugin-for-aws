...
<Fragment slot="terraform">
Les modules Terraform utilisent automatiquement le modèle router - c'est l'approche par défaut et la seule supportée. Le module généré crée une fonction Lambda unique qui gère toutes les opérations de l'API.
