...
Lorsque vous sélectionnez l'authentification `Cognito`, le générateur crée automatiquement le construct `UserIdentity` et configure le serveur MCP pour utiliser Cognito pour l'authentification.
