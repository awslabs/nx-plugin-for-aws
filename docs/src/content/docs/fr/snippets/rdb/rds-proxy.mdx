---
title: Configuration RDS Proxy
---
import Infrastructure from '@components/infrastructure.astro';

L'infrastructure générée inclut un [RDS Proxy](https://aws.amazon.com/rds/proxy/) par défaut, qui se situe entre votre application et le cluster Aurora. RDS Proxy offre plusieurs avantages :
