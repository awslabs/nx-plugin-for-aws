...
Les nouveaux espaces de travail sont configurés avec [Biome](https://biomejs.dev/) pour l'analyse statique et le formatage du code. L'exécution de `lint` vérifie les problèmes dans tous les projets, et `lint --configuration=fix` les corrige automatiquement.
