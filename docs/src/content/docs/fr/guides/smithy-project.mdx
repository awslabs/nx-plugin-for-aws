...
La CLI est résolue par [mise](https://mise.jdx.dev/), que le build récupère à la demande, donc il n'y a rien à installer — il télécharge et met en cache la version épinglée la première fois que vous construisez.
