...
La CLI est résolue par [mise](https://mise.jdx.dev/), ajouté à votre espace de travail en tant que dépendance de développement, donc il n'y a rien à installer — il télécharge et met en cache la version épinglée la première fois que vous construisez.
