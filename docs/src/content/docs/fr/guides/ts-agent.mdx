...
Si vous avez sélectionné `None` pour `computeType`, aucun construct CDK ou module Terraform n'est généré — le Agent ne peut être exécuté que localement.
</OptionFilter>
