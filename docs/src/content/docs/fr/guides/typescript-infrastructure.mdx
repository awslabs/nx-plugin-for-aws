...
Le stage sandbox est celui sur lequel agissent les cibles <Link path="/guides/typescript-infrastructure#déployer-votre-stage-sandbox">`deploy-sandbox`</Link> et <Link path="/guides/typescript-infrastructure#détruire-votre-stage-sandbox">`destroy-sandbox`</Link>.
