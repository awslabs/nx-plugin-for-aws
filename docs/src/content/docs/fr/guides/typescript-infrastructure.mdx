...
Pour plus d'informations sur CDK, veuillez vous référer au [Guide développeur CDK](https://docs.aws.amazon.com/cdk/v2/guide/core_concepts.html) et à la [Référence API](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-construct-library.html).férence API](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-construct-library.html).férence API](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-construct-library.html).