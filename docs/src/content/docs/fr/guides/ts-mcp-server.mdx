...
:::caution
Le SDK MCP ne prend actuellement en charge que Zod v3. Pour permettre l'utilisation de Zod v4 dans d'autres générateurs, la dépendance à Zod v3 est installée sous le nom `zod-v3`. Pour les schémas d'outils MCP, vous devrez importer Zod comme suit :
