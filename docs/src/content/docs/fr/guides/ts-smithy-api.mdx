...
:::caution[Windows]
`mise` ne publie aucun package Windows sur npm, donc installez la CLI Smithy vous-même avant de construire :
...
Consultez le [guide d'installation de la CLI Smithy](https://smithy.io/2.0/guides/smithy-cli/cli_installation.html) pour d'autres options.
:::
