...
:::tip
Pour une configuration simplifiée, utilisez le <Link path="/guides/connection/react-strands-agent">générateur Connection</Link> pour connecter votre site web React à un Strands Agent, qui configure automatiquement le client tRPC WebSocket avec l'authentification correcte.
