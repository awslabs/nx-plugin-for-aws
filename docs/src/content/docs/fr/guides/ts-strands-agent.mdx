...
:::tip
Si vous souhaitez une expérience similaire au <Link path="/guides/connection">générateur de connexion API</Link> pour les agents, veuillez +1 [ce problème GitHub](https://github.com/awslabs/nx-plugin-for-aws/issues/326).
:::