...
Contrairement aux options `enableWaf` et MFA ci-dessous, le mode d'application n'est pas exposé en tant que prop ou variable, donc cette modification s'applique à chaque `UserIdentity` dans votre espace de travail.
