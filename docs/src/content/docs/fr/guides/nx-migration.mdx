...
Pour le flux complet du point de vue de l'utilisateur effectuant la mise à niveau — y compris des exemples de sortie pour les migrations déterministes et agentiques — voir <Link path="/fr/get_started/upgrading">Mise à Niveau de Votre Espace de Travail</Link>.
