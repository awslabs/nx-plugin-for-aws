...
:::note[Système de design Cloudscape]
...
:::note[shadcn/ui]
Vous avez sélectionné [shadcn/ui](https://ui.shadcn.com/) comme `uxProvider`. Les composants et styles générés se trouvent aux côtés de TanStack Router / Vite — consultez la documentation Shadcn pour ajouter d'autres composants.
:::
</OptionFilter>

<OptionFilter when={{ uxProvider: 'None' }} description="No UX provider — bring your own component library">
:::note[Aucun fournisseur UX]
Vous avez sélectionné `None` pour `uxProvider`, donc aucune bibliothèque de composants ou système de design n'est configuré. Vous êtes libre d'ajouter la bibliothèque de composants de votre choix.
:::
</OptionFilter>
