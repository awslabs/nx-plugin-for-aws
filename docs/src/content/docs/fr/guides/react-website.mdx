...
<Fragment slot="terraform">
Pour déployer votre site, nous recommandons d'utiliser le <Link path="/guides/terraform-project">générateur `terraform#project`</Link> pour créer un projet Terraform.
