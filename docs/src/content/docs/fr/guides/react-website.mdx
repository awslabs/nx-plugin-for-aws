...
export class ApplicationStack extends Stack {
  constructor(scope: Construct, id: string) {
    ...
    // Le site web peut être déclaré à n'importe quel moment — la config runtime est résolue de manière paresseuse
...
:::note
Avec CDK, le construct de site web peut être déclaré à n'importe quel moment dans votre stack. La configuration runtime est résolue de manière paresseuse au moment de la synthèse, donc toutes les valeurs seront incluses quel que soit l'ordre de déclaration.
:::
</Fragment>
<Fragment slot="terraform">
