...
La migration de base de données s'exécute en tant qu'image de conteneur construite pendant le `build` de votre projet. Cette image est analysée pour détecter les vulnérabilités comme décrit ci-dessous.
