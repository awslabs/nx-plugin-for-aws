...
1. Un projet Python avec un composant <Link path="guides/py-agent">Agent</Link> (n'importe quel protocole)
...
- packages/common/agent\_connection
  - \<scope>\_agent\_connection
    ...
    - core
      ...
      - agentcore\_a2a\_client\_strands.py Client A2A Strands encapsulant la configuration
      - auth/ `httpx.Auth` SigV4 / transfert de session indépendant du framework
    - app
      - \<target\_agent\_name>\_client\_strands.py Client Strands par connexion pour chaque agent A2A
