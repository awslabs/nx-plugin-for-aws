...
:::note
Au moment de la rédaction, la méthode `grantInvoke` du runtime de l'agent core n'inclut pas encore cette permission automatiquement (voir [aws-cdk#37495](https://github.com/aws/aws-cdk/issues/37495)).
:::
