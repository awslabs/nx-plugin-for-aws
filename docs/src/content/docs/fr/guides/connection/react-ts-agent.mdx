...
3. Comme avec les API connectées, l'authentification est ignorée en mode `dev` lorsque <Link path="guides/react-website#runtime-configuration">`runtime-config.json`</Link> n'est pas présent
