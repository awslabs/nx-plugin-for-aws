...
Le générateur `connection` peut connecter votre <Link path="guides/py-agent">Python Strands Agent</Link> à un serveur MCP (soit <Link path="guides/ts-mcp-server">TypeScript</Link> soit <Link path="guides/py-mcp-server">Python</Link>).
...
1. Un projet Python avec un composant <Link path="guides/py-agent">Strands Agent</Link>
