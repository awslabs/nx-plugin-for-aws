---
title: Python Agent vers Base de données relationnelle
description: Connecter un Python Agent à une base de données relationnelle
when:
  sourceType: py#agent
  targetType: py#rdb
---
...
Le générateur `connection` relie un <Link path="guides/py-agent">Python Agent</Link> à un projet <Link path="guides/py-rdb">Python Relational Database</Link>, rendant la session de base de données disponible dans vos outils d'agent.
