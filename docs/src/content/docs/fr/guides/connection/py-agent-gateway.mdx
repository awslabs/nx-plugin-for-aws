...
- packages/common/agent\_connection
  - \<scope>\_agent\_connection
    - core/
      ...
      - agentcore\_gateway\_mcp\_client\_strands.py Client MCP Strands pour la Gateway déployée
      - auth/ `httpx.Auth` SigV4 / transfert de session indépendant du framework
    - app/
      - \<gateway\_snake>\_client\_strands.py Wrapper client Strands par Gateway
