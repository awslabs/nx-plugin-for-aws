...
4. Cognito Auth ajouté via le <Link path="/guides/react-website-auth">générateur `ts#website#auth`</Link> si vous vous connectez à une API qui utilise l'authentification Cognito ou IAM
