...
Pour plus d'informations sur la définition de procédures de souscription dans votre backend, consultez le <Link path="guides/trpc">guide du générateur d'API tRPC</Link>.
