...
Si vous travaillez simultanément sur votre application React et votre FastAPI, utilisez la cible `dev` de l'application React qui régénérera automatiquement le client à chaque modification de l'API, tout en rechargeant à chaud votre site et le serveur FastAPI local :
