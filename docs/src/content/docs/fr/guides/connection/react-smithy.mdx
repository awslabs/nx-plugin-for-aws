...
Si vous travaillez simultanément sur votre application React et votre API Smithy, utilisez la cible `dev` de l'application React. Cela régénérera automatiquement le client à chaque changement d'API, avec rechargement à chaud du site et du serveur Smithy local :
