...
- src
  - components
    ...
    - copilot
      - index.tsx Ré-exporte `CopilotChat`, `CopilotSidebar` et `CopilotPopup` avec des valeurs par défaut de slots qui correspondent au `ux` de votre site web (Cloudscape, Shadcn, ou aucun thème).
