...
Les deux valeurs proviennent du navigateur, elles nomment donc une conversation sans dire à qui elle appartient. Pour restreindre chaque utilisateur à ses propres conversations, consultez <Link path="guides/ts-agent">Restriction des sessions à leur propriétaire</Link>.
