...
2. Un Python Strands Agent avec `protocol=AG-UI` (généré avec le <Link path="guides/py-agent">générateur `py#agent`</Link>)
...
- <Link path="guides/py-agent">Guide Python Strands Agent</Link>
- <Link path="guides/connection/react-py-agent">Guide React vers Python Strands Agent (HTTP)</Link>
