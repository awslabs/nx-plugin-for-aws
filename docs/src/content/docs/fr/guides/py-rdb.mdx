...
`my_scope_my_db` est le nom du module de votre projet de base de données — un module plat unique nommé `<scope>_<name>`, visible en tant que répertoire de package à l'intérieur du projet.
