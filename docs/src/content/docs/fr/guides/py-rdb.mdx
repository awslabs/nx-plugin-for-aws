...
Pour les images de conteneur basées sur Debian, ajoutez le bundle CA Amazon RDS au magasin de confiance système :
...
Pour les images de conteneur basées sur Amazon Linux, utilisez plutôt la commande `update-ca-trust` :
