...
<FileTree>
  ...
  - package.json Manifeste de projet définissant le nom du package et les dépendances du projet
...
Si vous avez sélectionné CDK pour votre `iac`, lorsque vous ajoutez ou supprimez une procédure dans votre API tRPC, ces changements seront reflétés immédiatement dans le construct CDK sans avoir à reconstruire.
:::
