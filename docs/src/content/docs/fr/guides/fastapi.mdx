...
Nous ne supportons pas les intégrations typées pour Terraform, donc aucune cible de génération de code n'est configurée si vous avez choisi Terraform comme `iac`.
:::
</Fragment>
</Infrastructure>
