...
<CardGrid>
  ...
  <ConnectionCard
    ...
    href={`/nx-plugin-for-aws/${Astro.currentLocale || 'fr'}/guides/connection/ts-agent-dynamodb`}
    source="strands"
  ...
  <ConnectionCard
    ...
    description="Connecter un TypeScript MCP Server à une table DynamoDB"
    href={`/nx-plugin-for-aws/${Astro.currentLocale || 'fr'}/guides/connection/ts-mcp-server-dynamodb`}
    source="mcp"
    target="dynamodb"
  />
</CardGrid>
