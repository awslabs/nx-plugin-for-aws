...
<CardGrid>
  <ConnectionCard
    ...
    description="Appeler un Agent Python depuis un site web React"
  ...
  <ConnectionCard
    ...
    description="Appeler un Agent exposant le protocole AG-UI depuis un site web React via CopilotKit"
  ...
  <ConnectionCard
    ...
    description="Connecter un Agent Python à un serveur MCP"
  ...
  <ConnectionCard
    ...
    description="Connecter un Agent TypeScript à un agent A2A distant"
  ...
  <ConnectionCard
    ...
    description="Connecter un Agent Python à une table DynamoDB"
  ...
  <ConnectionCard
    ...
    description="Connecter un Agent Python à une passerelle AgentCore"
