...
- your-plugin/
  ...
  - package.json Configuration du package du plugin
...
Consultez le <Link path="/guides/nx-generator">guide `ts#nx-generator`</Link> pour les détails d'implémentation des générateurs.
:::
