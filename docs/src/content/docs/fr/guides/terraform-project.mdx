...
Un projet sans fichiers de test est un succès sans opération, vous pouvez donc ajouter des tests quand vous en avez besoin. Cette cible ne fait pas partie de `build`, car l'exécution des tests télécharge les fournisseurs — invoquez-la directement, ou depuis la CI où Terraform est disponible.
