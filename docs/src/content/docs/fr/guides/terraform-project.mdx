...
:::tip
Par défaut, toutes les cibles utilisent l'environnement `dev`, mais vous pouvez cibler un environnement spécifique comme suit : <NxCommands commands={['run tf-infra:apply --configuration=prod']} />
